function script_GetSubElementTreeType(argument0) {
	//Note: This script returns the cooresponding 'shape' of the elemental tree
	//1 : linear
	//2 : Bident
	//3 : Trident
	//4 : quadent (magic branch split)
	//5 : Terra
