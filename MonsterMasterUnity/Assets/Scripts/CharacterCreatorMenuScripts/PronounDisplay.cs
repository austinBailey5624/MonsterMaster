...
public class PronounDisplay : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        this.gameObject.GetComponent<TMP_Text>().text = mainCharacter.GetComponent<Person>().subjectPronoun
            + ", " + mainCharacter.GetComponent<Person>().objectPronoun
            + ", " + mainCharacter.GetComponent<Person>().possesivePronoun;
    }
}
