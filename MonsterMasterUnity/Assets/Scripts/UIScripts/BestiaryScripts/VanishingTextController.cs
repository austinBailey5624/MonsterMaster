...
public class VanishingTextController : MonoBehaviour
{
    ...
    public void appearText(string subelementName)
    {
        ...
        DesignColors colors = GameState.designColorsController.getElementDesignColors(subelementName);
        selectedText.gameObject.GetComponent<TMP_Text>().color = colors.textColor;
    }
