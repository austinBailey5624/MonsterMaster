...
public class Bestiary 
{
	...
	public static MonsterTree[][] generateBestiary()
	{
		String[][] typeNames=defineTypes();
...
//		bestiary[0][0][0][0]=new MonsterType("Pyro Egg",0,0,0,0,"An orange egg with the symbol of a red flame. When you touch it, it is warm, and you become angry, though you do not know why. Pull your hand away and you are burned, though by the egg or yourself you cannot tell",pyroTree.m_infants[0]);
		...
		bestiary[1][3][3][4].setEvolvesFrom1(bestiary[1][3][2][3]);
		...
		bestiary[2][2][4][5]=new MonsterType("Tree Hugger Hugger Tree",2,2,4,4,"The Tree Hugger Hugger Tree is a tree that loves hugging, especially tree huggers, which is fortunate, because only tree huggers hug trees.");
	...
	{
		exit=false;
		String mainBestiaryMenuOptions="Bestiary main menu, choose primary element:\n1) Fire \n2) Water \n3) Earth \n4) Air \n5) Light \n6) Dark\n7) Back\n8) Exit";
		while(!exit)
		{
...
//				transverseBestiaryShowAllMonstersInTree(primary,secondary,choice-1,bestiary);
	...
	{
		MonsterTree[][] bestiary = generateBestiary();
