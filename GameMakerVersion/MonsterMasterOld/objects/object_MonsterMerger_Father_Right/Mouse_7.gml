...
{	//And there is no monster selected for the father
	if(object_MonsterMerger_Mother_Left.m_Monster == noone)
	...
	{	//Combine monsters logic
		var motherSubelement = object_MonsterMerger_Mother_Left.m_Monster.m_subelement;
		var fatherSubelement = m_Monster.m_subelement;
		...
		//Kill the parents
		m_Monster = noone;
		object_MonsterMerger_Mother_Left.m_Monster = noone;
	}
}