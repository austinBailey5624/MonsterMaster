...
if(tilemap_get_at_pixel(collisionLayer,m_Lead.bbox_right+32,m_Lead.bbox_top)!=0 || (tilemap_get_at_pixel(collisionLayer,m_Lead.bbox_right+32,m_Lead.bbox_bottom)!=0))
{
	return;
}
