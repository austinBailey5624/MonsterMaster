...
4. **The world is open.** Although there are gates to certain areas, (and certain areas are much more difficult than others) you can directly open them by offering a monster with certain stats
5. **You can Combine monsters.** Part of the game is combining your monsters to make better monsters because there is a
6. **Level Cap.** The level of monsters is capped based on its generation- how many monsters are in its family tree. A second generation will be more powerful and have a higher level cap than a first generation etc etc
7. **You dont catch monsters with pokeballs.** Instead, you try and impose your will over it and your success will be determined by your level differential and also the decisions youve made in the game - an aggressive player will be better at catching fire monsters, a passive player water etc.
...
1. **Elements**
  ...
  * **Light**
    * Light elementals are people who follow a cause or a set of beleifs with utmost rigor. They tend to be religious and how they act is usually based on the tenants of that religion. They deal more damage, and take more damage from Dark Elementals
  * **Dark**
