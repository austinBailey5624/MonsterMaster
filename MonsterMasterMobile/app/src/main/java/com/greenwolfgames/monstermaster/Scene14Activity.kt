...
//        val currentState = extras?.getSerializable("state") as State
    ...
    private fun getScene14Node(index: Int): Node {
        ...
        if(index == 1)
        {
            val choice1 = Choice(getString(R.string.scene14node1choice1),2, {state -> state.addScore(Element.DARK, 1)}, Element.DARK)
            val choice2 = Choice(getString(R.string.scene14node1choice2),3, {state -> state.addScore(Element.WATER, 1)}, Element.WATER)
            val choice3 = Choice(getString(R.string.scene14node1choice3),4, {state -> state.addScore(Element.AIR, 1)}, Element.AIR)
        ...
        if(index == 2)
        {
            val choice1 = Choice(getString(R.string.scene14node2choice1),6, {state -> state.addScore(Element.FIRE, 1)}, Element.FIRE)
            val choice2 = Choice(getString(R.string.scene14node2choice2),4, {state -> state.addScore(Element.WATER, 1)}, Element.WATER)
            val choice3 = Choice(getString(R.string.scene14node2choice3),4, {state -> state.addScore(Element.EARTH, 1)}, Element.EARTH)
            return Node(index, getString(R.string.scene14node2prompt), listOf(choice1, choice2, choice3))
        }
        if(index == 3)
        {
            val choice1 = Choice(getString(R.string.scene14node3choice1),6, {state -> state.addScore(Element.FIRE, 1)}, Element.FIRE)
            val choice2 = Choice(getString(R.string.scene14node3choice2), 4, {state -> state.addScore(Element.WATER, 1)}, Element.WATER)
            val choice3 = Choice(getString(R.string.scene14node3choice3), 4, {state -> state.addScore(Element.EARTH, 1)}, Element.EARTH)
            return Node(index, getString(R.string.scene14node3prompt), listOf(choice1, choice2, choice3))
        }
        if(index == 4)
        {
            val choice1 = Choice(getString(R.string.scene14node4choice1), 7, {}, Element.NEUTRAL)
            val choice2 = Choice(getString(R.string.scene14node4choice2), 8, {}, Element.NEUTRAL)
            val choice3 = Choice(getString(R.string.scene14node4choice3), 9, {state -> state.addScore(Element.DARK,1)}, Element.DARK)
            val choice4 = Choice(getString(R.string.scene14node4choice4), 0, {state -> state.addScore(Element.EARTH,1)}, Element.EARTH)
            val choice5 = Choice(getString(R.string.scene14node4choice5), 0, {state -> state.addScore(Element.AIR, 1)}, Element.AIR)
        ...
        if(index == 6)
        {
            val choice1 = Choice(getString(R.string.scene14node6choice1), 7, {}, Element.NEUTRAL)
            val choice2 = Choice(getString(R.string.scene14node6choice2), 8,{}, Element.NEUTRAL)
            val choice3 = Choice(getString(R.string.scene14node6choice3), 9, {state -> state.addScore(Element.DARK, 1)}, Element.DARK)
            val choice4 = Choice(getString(R.string.scene14node6choice4), 0, {state -> state.addScore(Element.EARTH, 1)}, Element.EARTH)
            val choice5 = Choice(getString(R.string.scene14node6choice5), 0, {state -> state.addScore(Element.AIR, 1)}, Element.AIR)
            val choice6 = Choice(getString(R.string.scene14node6choice6),10, {state -> state.addScore(Element.DARK, 1)}, Element.DARK)
            return Node(index, getString(R.string.scene14node6prompt), listOf(choice1, choice2, choice3, choice4, choice5, choice6))
        }
        if(index == 7)
        {
            val choice1 = Choice(getString(R.string.scene14node7choice1), 11, {}, Element.NEUTRAL)
            val choice2 = Choice(getString(R.string.scene14node7choice2), 12, {state -> state.addScore(Element.LIGHT)}, Element.LIGHT)
            return Node(index, getString(R.string.scene14node7prompt), listOf(choice1, choice2))
        }
        if(index == 8)
        {
            val choice1 = Choice(getString(R.string.scene14node8choice1), 13, {}, Element.NEUTRAL)
            val choice2 = Choice(getString(R.string.scene14node8choice2), 13, {state -> state.addScore(Element.AIR)}, Element.AIR)
            val choice3 = Choice(getString(R.string.scene14node8choice3),13, {state -> state.addScore(Element.WATER)}, Element.WATER)
            return Node(index, getString(R.string.scene14node8prompt), listOf(choice1, choice2, choice3))
        }
        if(index == 9)
        {
            val choice1 = Choice(getString(R.string.scene14node9choice1), 7)
            val choice2 = Choice(getString(R.string.scene14node9choice2),8)
            val choice3 = Choice(getString(R.string.scene14node9choice3),0)
            return Node(index, getString(R.string.scene14node9prompt), listOf(choice1, choice2, choice3))
        }
        if(index == 10)
        {
            val choice1 = Choice(getString(R.string.scene14node10choice1),8)
            val choice2 = Choice(getString(R.string.scene14node10choice2), 0)
            return Node(index, getString(R.string.scene14node10prompt), listOf(choice1, choice2))
        }
        if(index == 11)
        {
            val choice1 = Choice(getString(R.string.scene14node11choice1), 0)
            val choice2 = Choice(getString(R.string.scene14node11choice2), 15)
        ...
        if(index == 13)
        {
            val choice1 = Choice(getString(R.string.scene14node13choice1), 0)
            return Node(index, getString(R.string.scene14node13prompt), listOf(choice1))
        }
        if(index == 14)
        {
            val choice1 = Choice(getString(R.string.scene14node14choice1), 4)
            val choice2 = Choice(getString(R.string.scene14node14choice2),18)
            val choice3 = Choice(getString(R.string.scene14node14choice3), 19)
            return Node(index, getString(R.string.scene14node14prompt), listOf(choice1, choice2, choice3))
        }
        if(index == 15)
        {
            val choice1 = Choice(getString(R.string.scene14node15choice1), 0)
            return Node(index, getString(R.string.scene14node15prompt), listOf(choice1))
        }
        if(index == 16)
        {
            val choice1 = Choice(getString(R.string.scene14node16choice1), 11)
            val choice2 = Choice(getString(R.string.scene14node16prompt), 17, {state -> state.addScore(Element.LIGHT)}, Element.LIGHT)
            return Node(index, getString(R.string.scene14node16prompt), listOf(choice1, choice2))
        }
        if(index == 17)
        {
            val choice1 = Choice(getString(R.string.scene14node17choice1), 0)
            val choice2 = Choice(getString(R.string.scene14node17choice2), 15)
            return Node(index, getString(R.string.scene14node17prompt), listOf(choice1, choice2))
        }
        if(index == 18)
        {
            val choice1 = Choice(getString(R.string.scene14node18choice1), 0)
            return Node(index, getString(R.string.scene14node18prompt), listOf(choice1))
        }
        if(index == 19)
        {
            val choice1 = Choice(getString(R.string.scene14node19choice1), 0)
