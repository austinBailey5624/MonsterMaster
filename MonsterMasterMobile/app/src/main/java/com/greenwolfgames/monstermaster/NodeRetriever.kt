...
class NodeRetriever(private val context: Context, private val state: State)
{
    ...
    fun getNode(index: Int): Node
    {
        ...
        if(index == 8)
        {
            ...
            val choices: List<Choice> =if(state.getScore(Element.TERRA) > state.getScore(Element.AERO))
            {
        ...
        if(index == 16)
        {
            val prompts: List<String> = if(state.getScore(Element.TERRA) > state.getScore(Element.AERO))
            {
        ...
        {
            val prompts: List<String>
            if(state.getScore(Element.LUXOR) > state.getScore(Element.UMBRAL) && state.getScore(Element.PYRO) > state.getScore(Element.AQUA))
            {
            ...
            else if(state.getScore(Element.UMBRAL) > state.getScore(Element.LUXOR) && state.getScore(Element.PYRO) > state.getScore(Element.AQUA))
            {
