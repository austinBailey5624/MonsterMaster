...
class NodeRetriever(private val context: Context, private val state: State)
{
    ...
    {
        state.visitNode(index) //Choose Between light or dark
        if (index == 1)
        {
        ...
        if (index == 80)
        {
            ...
            if (state.getQuestStage(Quest.MICHAEL_ATTITUDE) == 4) //insulted
            {
                ...
                val choices = listOf(Choice(getString(context, R.string.scene80alt2choice1), 253),
            ...
            if (state.getQuestStage(Quest.MICHAEL_ATTITUDE) == 3) //positive
            {
                ...
                val choices = listOf(Choice(getString(context, R.string.scene80alt3choice1), 93),
            ...
            if (state.getQuestStage(Quest.MICHAEL_ATTITUDE) == 5) // very positive
            {
                ...
                val choices = listOf(Choice(getString(context, R.string.scene80alt4choice1), 93),
            ...
            if (state.getQuestStage(Quest.MICHAEL_ATTITUDE) == 2)
            {
                ...
                val choices = listOf(Choice(getString(context, R.string.scene80alt5choice1), 93),
            ...
            else
            {
                ...
                }, Element.PYRO), Choice(getString(context, R.string.scene80choice2), 82, {
                    state.addScore(Element.AQUA);state.setQuestStage(Quest.MICHAEL_ATTITUDE, 2)
                }, Element.AQUA), Choice(getString(context, R.string.scene80choice3), 83, {
                    state.addScore(Element.TERRA);state.setQuestStage(Quest.MICHAEL_ATTITUDE, 1)
                }, Element.TERRA), Choice(getString(context, R.string.scene80choice4), 84, {
        ...
        if (index == 82)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene82choice1),
                101,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
        ...
        if (index == 84)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene84choice1),
                88,
                { state.addScore(Element.LUNAR) },
                Element.LUNAR),
                Choice(getString(context, R.string.scene84choice2),
                    89,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL),
        ...
        if (index == 85)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene85choice1),
                90,
                { state.addScore(Element.STORM) },
                Element.STORM), Choice(getString(context, R.string.scene85choice2), 91) {
        ...
        if (index == 87)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene87choice1), 86),
                Choice(getString(context, R.string.scene87choice2),
                    88,
                    { state.addScore(Element.LUXOR) },
                    Element.LUXOR),
                Choice(getString(context, R.string.scene87choice3),
                    94,
        ...
        if (index == 88)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene88choice1),
                93,
                { state.addScore(Element.LUXOR) },
        ...
        if (index == 93)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene93choice1),
                96,
                { state.addScore(Element.ANGEL) },
                Element.ANGEL),
                Choice(getString(context, R.string.scene93choice2), 96),
                Choice(getString(context, R.string.scene93choice3),
                    97,
        ...
        { //TODO: extend
            if (state.currentGold > 10)
            {
                ...
                val choices = mutableListOf(Choice(getString(context, R.string.scene94choice1),
                    95,
                    { state.addScore(Element.ANGEL) },
                    Element.ANGEL), Choice(getString(context, R.string.scene94choice4), 87))
                if (state.currentGold > 100)
                {
                    choices.add(Choice(getString(context, R.string.scene94choice2),
                        95,
                        { state.addScore(Element.ANGEL) },
                        Element.ANGEL))
                }
                ...
                {
                    choices.add(Choice(getString(context, R.string.scene94choice3),
                        95,
                        { state.addScore(Element.ANGEL) },
                        Element.ANGEL))
                }
        ...
        if (index == 97)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene97choice1),
                96,
                { state.addScore(Element.LUXOR) },
        ...
        if (index == 99)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene99choice1), 98),
                Choice(getString(context, R.string.scene99choice2),
                    100,
                    { state.addScore(Element.LUXOR) },
                    Element.LUXOR))
            return getFatherChurchNode(index, prompts, choices, context)
        ...
        if (index == 100)
        {
            val prompts = listOf(getString(context, R.string.scene100prompt1) + Gender.getNickname1(
                context,
        ...
        if (index == 102)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene102choice1),
                103,
                { state.addScore(Element.PYRO) },
                Element.PYRO),
                Choice(getString(context, R.string.scene102choice2),
                    104,
                    { state.addScore(Element.LUXOR) },
                    Element.LUXOR),
                Choice(getString(context, R.string.scene102choice3),
                    105,
                    { state.addScore(Element.PEGASUS) },
                    Element.PEGASUS),
                Choice(getString(context, R.string.scene102choice4),
                    106,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA),
                Choice(getString(context, R.string.scene102choice5), 107),
                Choice(getString(context, R.string.scene102choice6),
                    108,
        ...
        if (index == 103)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene103choice1),
                109,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
                Choice(getString(context, R.string.scene103choice2),
                    109,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL),
        ...
        if (index == 104)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene104choice1),
                111,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene104choice2),
                    112,
        ...
        if (index == 105)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene105choice1),
                114,
                { state.addScore(Element.BIRD) },
                Element.BIRD),
                Choice(getString(context, R.string.scene105choice2),
                    113,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 106)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene106choice1),
                133,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
                Choice(getString(context, R.string.scene106choice2),
                    115,
        ...
        if (index == 108)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene108choice1),
                112,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene108choice2),
                    131,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA),
                Choice(getString(context, R.string.scene108choice3),
                    140,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
                Choice(getString(context, R.string.scene108choice4),
                    152,
                    { state.addScore(Element.STORM) },
                    Element.STORM),
                Choice(getString(context, R.string.scene108choice5),
                    160,
                    { state.addScore(Element.AERO) },
                    Element.AERO),
                Choice(getString(context, R.string.scene108choice6),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 109)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene109choice1),
                112,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene109choice2),
                    131,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA),
                Choice(getString(context, R.string.scene109choice3),
                    140,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
                Choice(getString(context, R.string.scene109choice4),
                    152,
                    { state.addScore(Element.STORM) },
                    Element.STORM),
                Choice(getString(context, R.string.scene109choice5),
                    160,
                    { state.addScore(Element.AERO) },
                    Element.AERO),
                Choice(getString(context, R.string.scene109choice6),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 112)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene112choice1), 118),
                Choice(getString(context, R.string.scene112choice2),
                    119,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 113)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene113choice1),
                112,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene113choice1),
                    131,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA),
                Choice(getString(context, R.string.scene113choice3),
                    140,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
                Choice(getString(context, R.string.scene113choice4),
                    152,
                    { state.addScore(Element.STORM) },
                    Element.STORM),
                Choice(getString(context, R.string.scene113choice5),
                    160,
                    { state.addScore(Element.AERO) },
                    Element.AERO),
                Choice(getString(context, R.string.scene113choice6),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 114)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene114choice1),
                112,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene114choice2),
                    131,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA),
                Choice(getString(context, R.string.scene114choice3),
                    140,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
                Choice(getString(context, R.string.scene114choice4),
                    152,
                    { state.addScore(Element.STORM) },
                    Element.STORM),
                Choice(getString(context, R.string.scene114choice5),
                    160,
                    { state.addScore(Element.AERO) },
                    Element.AERO),
                Choice(getString(context, R.string.scene114choice6),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 115)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene115choice1), 131),
                Choice(getString(context, R.string.scene115choice2),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 117)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene117choice1),
                175,
                { state.addScore(Element.JUSTICE) },
                Element.JUSTICE),
                Choice(getString(context, R.string.scene117choice2),
                    112,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 120)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene120choice1), 121),
                Choice(getString(context, R.string.scene120choice2),
                    122,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 121)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene121choice1), 123),
                Choice(getString(context, R.string.scene121choice2),
                    122,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 123)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene123choice1),
                124,
                { state.addScore(Element.LUNAR) },
                Element.LUNAR),
                Choice(getString(context, R.string.scene123choice2),
                    122,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 124)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene124choice1),
                125,
                { state.addScore(Element.LUNAR) },
                Element.LUNAR),
                Choice(getString(context, R.string.scene124choice2),
                    126,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 125)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene125choice1),
                127,
                { state.addScore(Element.LUNAR) },
                Element.LUNAR),
                Choice(getString(context, R.string.scene125choice2),
                    126,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 128)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene128choice1),
        ...
        if (index == 131)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene131choice1),
                133,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
                Choice(getString(context, R.string.scene132choice2),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 133)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene133choice1),
                134,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
                Choice(getString(context, R.string.scene133choice2),
                    119,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 134)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene134choice1),
                135,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
                Choice(getString(context, R.string.scene134choice2),
                    119,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 135)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene135choice1),
                136,
                { state.addScore(Element.AQUA) },
                Element.AQUA),
                Choice(getString(context, R.string.scene135choice2),
                    122,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 137)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene137choice1), 79),
                Choice(getString(context, R.string.scene137choice2),
                    138,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 138)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene138choice1), 79),
                Choice(getString(context, R.string.scene138choice2),
                    139,
        ...
        if (index == 140)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene140choice1),
                141,
                { state.addScore(Element.STEAM) },
                Element.STEAM),
                Choice(getString(context, R.string.scene140choice2),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 141)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene141choice1),
                132,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene141choice2),
                    141,
                    { state.addScore(Element.STEAM) },
                    Element.STEAM))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 142)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene142choice1),
                143,
                { state.addScore(Element.STEAM) },
                Element.STEAM),
                Choice(getString(context, R.string.scene142choice2),
                    119,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 143)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene143choice1),
                144,
                { state.addScore(Element.STEAM) },
                Element.STEAM),
                Choice(getString(context, R.string.scene143choice2),
                    122,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 144)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene144choice1),
                145,
                { state.addScore(Element.STEAM) },
                Element.STEAM),
                Choice(getString(context, R.string.scene144choice2),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 146)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene146choice1),
                147,
                { state.addScore(Element.JUSTICE) },
                Element.JUSTICE),
                Choice(getString(context, R.string.scene146choice2), 148),
                Choice(getString(context, R.string.scene146choice3),
                    149,
                    { state.addScore(Element.DEMON) },
                    Element.DEMON))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 149)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene149choice1),
                150,
                { state.addScore(Element.JUSTICE) },
                Element.JUSTICE),
                Choice(getString(context, R.string.scene149choice2),
                    151,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
                Choice(getString(context, R.string.scene149choice3),
                    151,
                    { state.addScore(Element.DEMON) },
                    Element.DEMON))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 152)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene152choice1),
                132,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene152choice2),
                    153,
                    { state.addScore(Element.WEATHER) },
                    Element.WEATHER))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 153)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene153choice1),
                119,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene153choice2),
                    154,
                    { state.addScore(Element.WEATHER) },
                    Element.WEATHER))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 154)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene154choice1),
                122,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene154choice2),
                    155,
                    { state.addScore(Element.WEATHER) },
                    Element.WEATHER))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 157)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene157choice1),
                158,
                { state.addScore(Element.ANGEL) },
                Element.ANGEL),
                Choice(getString(context, R.string.scene157choice2),
                    159,
                    { state.addScore(Element.NIGHTWING) },
                    Element.NIGHTWING))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 160)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene160choice1),
                132,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene160choice2),
                    161,
                    { state.addScore(Element.AERO) },
                    Element.AERO))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 161)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene161choice1),
                119,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene161choice2),
                    163,
                    { state.addScore(Element.AERO) },
                    Element.AERO))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 162)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene162choice1),
                122,
                { state.addScore(Element.PHOENIX) },
                Element.PHOENIX),
                Choice(getString(context, R.string.scene162choice2),
                    163,
                    { state.addScore(Element.AERO) },
                    Element.AERO))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 168)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene168choice1),
                112,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene168choice2),
                    131,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA),
                Choice(getString(context, R.string.scene168choice3),
                    140,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
                Choice(getString(context, R.string.scene168choice4),
                    152,
                    { state.addScore(Element.STORM) },
                    Element.STORM),
                Choice(getString(context, R.string.scene168choice5),
                    160,
                    { state.addScore(Element.AERO) },
                    Element.AERO),
                Choice(getString(context, R.string.scene168choice6),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 169)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene169choice1),
                112,
                { state.addScore(Element.LUXOR) },
                Element.LUXOR),
                Choice(getString(context, R.string.scene169choice2),
                    132,
                    { state.addScore(Element.PHOENIX) },
                    Element.PHOENIX))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 170)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene170choice1),
                171,
                { state.addScore(Element.JUSTICE) },
                Element.JUSTICE),
                Choice(getString(context, R.string.scene170choice2),
                    171,
                    { state.addScore(Element.LUNAR) },
                    Element.LUNAR),
                Choice(getString(context, R.string.scene170choice3),
                    171,
                    { state.addScore(Element.COMPASSION) },
                    Element.COMPASSION),
                Choice(getString(context, R.string.scene170choice4),
                    171,
                    { state.addScore(Element.ANGEL) },
                    Element.ANGEL),
                Choice(getString(context, R.string.scene170choice5),
                    171,
                    { state.addScore(Element.REDEMPTION) },
                    Element.REDEMPTION),
                Choice(getString(context, R.string.scene170choice6),
                    112,
                    { state.addScore(Element.AQUA) },
                    Element.AQUA))
            return getBrahmNode(index, prompts, choices, context)
        ...
        if (index == 172)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene172choice1), 173),
        ...
        if (index == 177)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene177choice1),
                178,
                { state.addScore(Element.TERRA) },
                Element.TERRA),
                Choice(getString(context, R.string.scene177choice2),
                    179,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL),
                Choice(getString(context, R.string.scene177choice3), 180),
                Choice(getString(context, R.string.scene177choice4),
                    181,
                    { state.addScore(Element.AERO) },
                    Element.AERO),
                Choice(getString(context, R.string.scene177choice5),
                    182,
                    { state.addScore(Element.PYRO) },
                    Element.PYRO),
        ...
        if (index == 178)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene178choice1),
                182,
                { state.addScore(Element.PYRO) },
                Element.PYRO),
                Choice(getString(context, R.string.scene178choice2),
                    183,
                    { state.addScore(Element.STORM) },
                    Element.STORM),
        ...
        if (index == 179)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene179choice1),
                184,
                { state.addScore(Element.PYRO) },
                Element.PYRO),
                Choice(getString(context, R.string.scene179choice2),
                    185,
        ...
        if (index == 187)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene187choice1), 188),
                Choice(getString(context, R.string.scene187choice2), 206),
                Choice(getString(context, R.string.scene187choice3), 217),
                Choice(getString(context, R.string.scene187choice4),
        ...
        if (index == 188)
        {
            ...
            {
                choices = listOf(Choice(getString(context, R.string.scene188choice1), 189),
            ...
            {
                choices = listOf(Choice(getString(context, R.string.scene188choice5), 235),
                    Choice(getString(context, R.string.scene188choice4), 190),
                    Choice(getString(context, R.string.scene188choice6), 203))
            }
            else if (state.getQuestStage(Quest.CHORES) == 5)
            {
                choices = listOf(Choice(getString(context, R.string.scene188choice2), 189),
                    Choice(getString(context, R.string.scene188choice4), 190),
                    Choice(getString(context, R.string.scene188choice6), 203))
            }
            else if (state.getQuestStage(Quest.CHORES) == 8)
            {
                choices = listOf(Choice(getString(context, R.string.scene188choice3), 189),
                    Choice(getString(context, R.string.scene188choice4), 190),
                    Choice(getString(context, R.string.scene188choice6), 203))
            }
            else
            {
                choices = listOf(Choice(getString(context, R.string.scene188choice4), 190),
                    Choice(getString(context, R.string.scene188choice6), 203))
            }
        ...
        if (index == 189)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene189choice1),
                191,
                { state.addScore(Element.AERO) },
                Element.AERO),
                Choice(getString(context, R.string.scene189choice2),
                    192,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 190)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene190choice1),
                191,
                { state.addScore(Element.AERO) },
                Element.AERO),
                Choice(getString(context, R.string.scene190choice2),
                    192,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 191)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene191choice1),
                193,
                { state.addScore(Element.TERRA) },
                Element.TERRA),
                Choice(getString(context, R.string.scene191choice2),
                    194,
                    { state.addScore(Element.AERO) },
                    Element.AERO))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 192)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene192choice1),
                196,
                { state.addScore(Element.ROTTEN) },
                Element.ROTTEN),
                Choice(getString(context, R.string.scene192choice2),
                    191,
                    { state.addScore(Element.AERO) },
                    Element.AERO))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 193)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene193choice1),
                197,
                { state.addScore(Element.COMPASSION) },
                Element.COMPASSION), Choice(getString(context, R.string.scene193choice2), 198))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
                R.anim.fade_in_fast,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 194)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene194choice1),
                197,
                { state.addScore(Element.COMPASSION) },
                Element.COMPASSION), Choice(getString(context, R.string.scene194choice2), 198))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
                R.anim.fade_in_fast,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 195)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene195choice1), 199),
                Choice(getString(context, R.string.scene195choice2),
                    187,
        ...
        if (index == 196)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene196choice1),
                200,
                { state.addScore(Element.UMBRAL) },
                Element.UMBRAL), Choice(getString(context, R.string.scene196choice2), 191))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
                R.anim.fade_in_fast,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 197)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene197choice1),
                198,
                { state.addScore(Element.COMPASSION) },
                Element.COMPASSION),
                Choice(getString(context, R.string.scene197choice2),
                    201,
                    { state.addScore(Element.NIGHTWING) },
                    Element.NIGHTWING))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 198)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene198choice),
                187,
        ...
        if (index == 199)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene199choice1),
                197,
                { state.addScore(Element.COMPASSION) },
                Element.COMPASSION), Choice(getString(context, R.string.scene199choice2), 198))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
                R.anim.fade_in_fast,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 200)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene200choice1), 191),
                Choice(getString(context, R.string.scene200choice2),
                    202,
                    { state.addScore(Element.UMBRAL) },
                    Element.UMBRAL))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 201)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene201choice),
                187,
                { state.setQuestStage(Quest.MORNS_ERRAND, 9) }))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
                R.anim.fade_in_fast,
        ...
        if (index == 202)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene202choice1),
                197,
                { state.addScore(Element.COMPASSION) },
                Element.COMPASSION),
                Choice(getString(context, R.string.scene202choice2), 198),
                Choice(getString(context, R.string.scene202choice3),
                    201,
                    { state.addScore(Element.STORM) },
                    Element.STORM))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
        ...
        if (index == 206)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene206choice1), 207),
        ...
        if (index == 207)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene207choice1), 209),
        ...
        if (index == 208)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene208choice1), 187),
        ...
        if (index == 209)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene209choice1), 219),
        ...
        if (index == 210)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene210choice1), 187),
        ...
        if (index == 211)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene211choice1), 207),
                Choice(getString(context, R.string.scene211choice2), 214),
                Choice(getString(context, R.string.scene211choice3),
                    212,
                    { state.addScore(Element.VENGEANCE) },
                    Element.VENGEANCE),
        ...
        if (index == 212)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene212choice1), 213),
        ...
        if (index == 213)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene213choice1), 207),
        ...
        if (index == 214)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene214choice1), 215),
        ...
        if (index == 215)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene215choice1), 216),
        ...
        if (index == 216)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene216choice1), 207),
        ...
        if (index == 217)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene217choice1), 218),
        ...
        if (index == 218)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene218choice), 187))
            val animations = listOf(AnimationInfo(R.drawable.character_black_cat,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 219)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene219choice1), 220),
        ...
        if (index == 220)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene220choice1), 221),
        ...
        if (index == 221)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene221choice1), 225),
        ...
        if (index == 222)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene222choice1), 227),
        ...
        if (index == 223)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene223choice1), 228),
        ...
        if (index == 224)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene224choice1), 228),
        ...
        if (index == 225)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene225choice), 226))
            val animations = listOf(AnimationInfo(R.drawable.character_mad_prophet,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 226)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene226choice1), 227),
        ...
        if (index == 227)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene227choice1), 228),
        ...
        if (index == 228)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene228choice1), 229),
        ...
        if (index == 229)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene229choice1), 230),
        ...
        if (index == 230)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene230choice1),
                233,
                { state.addScore(Element.REDEMPTION) },
                Element.REDEMPTION),
                Choice(getString(context, R.string.scene230choice2),
                    234,
                    { state.addScore(Element.LUXOR) },
                    Element.LUXOR),
                Choice(getString(context, R.string.scene230choice3),
                    187,
                    { state.addScore(Element.ROTTEN) },
                    Element.ROTTEN))
            val animations = listOf(AnimationInfo(R.drawable.character_mad_prophet,
        ...
        if (index == 231)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene231choice1), 228),
        ...
        if (index == 232)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene232choice1), 228),
        ...
        if (index == 233)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene233choice), 187))
            val animations = listOf(AnimationInfo(R.drawable.character_mad_prophet,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 234)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene234choice), 187))
            val animations = listOf(AnimationInfo(R.drawable.character_mad_prophet,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 235)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene235choice1),
                196,
                { state.addScore(Element.AERO) },
                Element.AERO), Choice(getString(context, R.string.scene235choice2), 187))
            val animations = listOf(AnimationInfo(R.drawable.character_morn,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 236)
        {
            ...
            {
                choices = listOf(Choice(getString(context, R.string.scene236choice1), 237),
        ...
        if (index == 237)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene237choice), 79))
            val animations = listOf(AnimationInfo(R.drawable.background_oaktree_pawnshop,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 238)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene238choice1), 239),
        ...
        if (index == 239)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene239choice1),
                241) { state.addGold(20) },
        ...
        if (index == 240)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene240choice1), 243),
        ...
        if (index == 241)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene241choice1), 243),
        ...
        if (index == 242)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene242choice1),
                245) { state.addGold(22);state.setQuestStage(Quest.SELL_AMULET, 2) },
                Choice(getString(context, R.string.scene242choice2), 246) {
        ...
        if (index == 243)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene243choice1), 250))
            val animations = listOf(AnimationInfo(R.drawable.background_oaktree_pawnshop,
                R.anim.appear,
                R.id.background_center))
            return Node(index, prompts, choices, animations, context)
        ...
        if (index == 244)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene244choice1), 248) {
        ...
        if (index == 245)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene245choice1), 243),
        ...
        if (index == 246)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene246choice1),
                79,
                state,
                Element.AERO),
        ...
        if (index == 247)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene247choice1), 249),
        ...
        if (index == 248)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene248choice1),
                79,
                state,
                Element.AERO),
        ...
        if (index == 249)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene249choice1), 243),
        ...
        if (index == 250)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene250choice1), 243),
        ...
        if (index == 251)
        {
            val choices = listOf(Choice(getString(context, R.string.scene251choice1), 254),
        ...
        if (index == 252)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene252choice1),
                258,
                state,
                Element.PYRO),
        ...
        if (index == 253)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene253choice1),
                259,
                state,
                Element.TERRA),
        ...
        if (index == 254)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene254choice1), 261),
        ...
        if (index == 257)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene257choice1), 254),
        ...
        if (index == 258)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene258choice1),
                80,
                state,
                Element.UMBRAL),
        ...
        if (index == 259)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene259choice1), 93),
        ...
        if (index == 261)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene261choice1),
                265,
                state,
                Element.JUSTICE),
                Choice(getString(context, R.string.scene261choice2), 266, state, Element.LUNAR),
                Choice(getString(context, R.string.scene261choice3),
                    267,
                    state,
                    Element.COMPASSION),
                Choice(getString(context, R.string.scene261choice4), 268, state, Element.ANGEL),
                Choice(getString(context, R.string.scene261choice5),
                    269,
                    state,
                    Element.REDEMPTION),
        ...
        if (index == 263)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene263choice1), 254),
        ...
        if (index == 264)
        {
            ...
            val choices = listOf(Choice(getString(context, R.string.scene264choice1), 254),
