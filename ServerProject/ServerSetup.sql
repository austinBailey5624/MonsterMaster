...
VALUES
    ...
    ('Small Elf Ear','A small elf ear from a rabid elf, increases earth damage by 1 point while equipped',21,4,'When Equippped, increase Earth damage by 1 point','30% drop from Aos Si, 50% drop from Tallf, 70% drop from Elder Elf','ACCESSORY'),
    ('Elf Ear','An Elf ear of a rabid elf, increase earth damage and physical damage by 1 point while equipped',21,8,'When equipped, increase Earth and physcial damage by 1 point','30% drop from Aos si, 50% drop from Elder Elf','ACCESSORY'),
    ('Long Elf Ear','A majestic elf ear, slightly increases earth, physical and magical damage by 1 point while equipped',21,12,'When equipped, increase Earth, physical and magic damage by 1 point','30% drop from Elder Elf','ACCESSORY'),
    ('Minor Staff','A weak stick that somehow enhances magic',21,1,'When equipped, increase magic damage by 1 point,','30% drop from Shaboy, 50% drop from Shaman, 70% drop from Shamage','WEAPON'),
    ('Shaman Staff','A magic staff',21,5,'When equipped, increase magic damage by 2 points','30% drop from Shaman, 50% drop from shamage','WEAPON'),
    ('Shamage Staff','A powerful sage\'s staff',21,9,'When equipped, increase magic damage by 3 points','30% drop from Shamage','WEAPON'),
