...
VALUES
    ...
    ('Age','Fundamental',1,5),
    ('Body Type 1','Fundamental',1,50),
    ('Body Type 2','Fundamental',0,50),
    ('Body Type 3','Fundamental',0,50),
    ...
    ('Physical','Evolutionary',-10,10),
    ('Balanced','Evolutionary',-10,10),
    ('Magical','Evolutionary',-10,10),
...
VALUES
    ...
    (3,28,'Raptor, These monsters are shaped like veloceraptors, with heads that bite and claws that slash.'),
    (3,29,'Rat, these disgusting little rodents carry all sorts of disease .'),
    (3,30,'Scavenger, These vultures eat corpses, and can sense death. When they do, they circle above, waiting for their next meal.'),
    (3,31,'Scorpion, Native to deserts and darkness, these plated insects have poisonous stingers and vicious claws.'),
    (3,32,'Snake, These limbless reptiles are known to wind their bodies around prey to squeeze the life out of them. Their fangs are deadly poison, and nothing escapes thier slitted souless eyes.'),
    (3,33,'Soldier, These humaniod monsters are equipped in armor, swords and shields.'),
    (3,34,'Sphynx, These sentient cats have the head of a man, and speak in riddles.'),
    (3,35,'Squid, This monster dwells in the deep. Their squishy body ripples with muscles, and they are ferocious protectors of the depths.'),
    (3,36,'Starfish, This star shaped monster clings to stones in the depths of the ocean, eating small animals underneath it.'),
    (3,37,'Steam Blob, Made entirely of steam, this blob shaped monster dwells in hot caverns deep in the earth.'),
    (3,38,'Stone, This monster is made entirely of stone.'),
    (3,39,'Sword, This monster is a master of the sword.'),
    (3,40,'Symbol, This monster embodies a symbolic representation of a concept.'),
    (3,41,'Tree, This monster is a tree.'),
    (3,42,'Turtle, This monster has a large shell it can hide in in a moments notice.'),
    (3,43,'Tyrant, This monster resembles a tyrannosaurous rex.'),
    (3,44,'Wasp, This monster resembles a flying insect with a stinger.'),
    (3,45,'Wolf, This monster resembles a canine.'),
    (3,46,'Liquid, This monstetr is a sentient liquid.'),
    (3,47,'Cow, This monster resembles a bovine.'),
    (3,48,'Spider, this poisous monster has 8 legs and many eyes.'),
    (4,1,'Angel, This monster resembles an angel, servant of the divine.'),
    (4,2,'Badger, This monster resembles a small omnivore woodland creature.'),
    (4,3,'Bat, This monster takes the form of a flying mammal with leathery wings.'),
    (4,4,'Bear, This monster takes the form of a giant doglike carnivore.'),
    (4,5,'Bird, This monster takes the form of a flying animal with feathers.'),
    (4,6,'Blob, This monster takes the form of an amorphus blob.'),
    (4,7,'Camel, This monster is great at helping the party navigate harsh arid weather enviornments.'),
    (4,8,'Cloud, This monster takes the form of a cloud in the sky.'),
    (4,9,'Corpse, This monster takes the form of a corpse, and counts as a corpse in all death calculations, even while alive.'),
    (4,10,'Demon, With demonic horns and evil eyes, this monster is not to be trusted.'),
    (4,11,'Disease, Sickness and plague follow wherever this monster goes.'),
    (4,12,'Dragon, this monster takes the form of a great dragon, with potent breath, wings and claws.'),
    (4,13,'Elf, Mischevious and tricky, this monster takes the form of an elf.'),
    (4,14,'Fish, Happier in water, this monster resembles a fish, and prefers the depths.'),
    (4,15,'Fox, Small, clever and mischevious, this monster resembles a fox spirit, and may attempt to trick you.'),
    (4,16,'Frog, This wily amphibious monster prefers a humid climate and may have special powers when kissed by a princess.'),
    (4,17,'Gem, This monster resembles a large expensive Gem with a powerful soul trapped inside.'),
    (4,18,'Ghost, This frightening monster feels cold when you pass through it.'),
    (4,19,'Golem, This monster resembles a moving statue.'),
    (4,20,'Horse, Fast and furious, this horse can be ridden, but only by those that care for it.'),
    (4,21,'Humanoid, This monster is vaguely human shaped, with a head, two arms and two legs.'),
    (4,22,'Jellyfish, This monster is a bell of jelly with a long potentially poisonous tail it uses to capture its prey.'),
    (4,23,'Light Blob, This monster is best described as a blob of light.'),
    (4,24,'Lizard, This monster is scaled and cold blooded.'),
    (4,25,'Monk, This monster resembles a holy monk.'),
    (4,26,'Penguin, A member of the royal family, this penguin either has serfs and land or is in line to inherit it.'),
    (4,27,'Plant, This monster is definately more flora than fauna, and feeds by drinking water in its roots and sunlight in its leaves.'),
    (4,28,'Raptor, These monsters are shaped like veloceraptors, with heads that bite and claws that slash.'),
    (4,29,'Rat, these disgusting little rodents carry all sorts of disease .'),
    (4,30,'Scavenger, These vultures eat corpses, and can sense death. When they do, they circle above, waiting for their next meal.'),
    (4,31,'Scorpion, Native to deserts and darkness, these plated insects have poisonous stingers and vicious claws.'),
    (4,32,'Snake, These limbless reptiles are known to wind their bodies around prey to squeeze the life out of them. Their fangs are deadly poison, and nothing escapes thier slitted souless eyes.'),
    (4,33,'Soldier, These humaniod monsters are equipped in armor, swords and shields.'),
    (4,34,'Sphynx, These sentient cats have the head of a man, and speak in riddles.'),
    (4,35,'Squid, This monster dwells in the deep. Their squishy body ripples with muscles, and they are ferocious protectors of the depths.'),
    (4,36,'Starfish, This star shaped monster clings to stones in the depths of the ocean, eating small animals underneath it.'),
    (4,37,'Steam Blob, Made entirely of steam, this blob shaped monster dwells in hot caverns deep in the earth.'),
    (4,38,'Stone, This monster is made entirely of stone.'),
    (4,39,'Sword, This monster is a master of the sword.'),
    (4,40,'Symbol, This monster embodies a symbolic representation of a concept.'),
    (4,41,'Tree, This monster is a tree.'),
    (4,42,'Turtle, This monster has a large shell it can hide in in a moments notice.'),
    (4,43,'Tyrant, This monster resembles a tyrannosaurous rex.'),
    (4,44,'Wasp, This monster resembles a flying insect with a stinger.'),
    (4,45,'Wolf, This monster resembles a canine.'),
    (4,46,'Liquid, This monstetr is a sentient liquid.'),
    (4,47,'Cow, This monster resembles a bovine.'),
    (4,48,'Spider, this poisous monster has 8 legs and many eyes.'),
	(5,1,'Angel, This monster resembles an angel, servant of the divine.'),
    (5,2,'Badger, This monster resembles a small omnivore woodland creature.'),
    (5,3,'Bat, This monster takes the form of a flying mammal with leathery wings.'),
    (5,4,'Bear, This monster takes the form of a giant doglike carnivore.'),
    (5,5,'Bird, This monster takes the form of a flying animal with feathers.'),
    (5,6,'Blob, This monster takes the form of an amorphus blob.'),
    (5,7,'Camel, This monster is great at helping the party navigate harsh arid weather enviornments.'),
    (5,8,'Cloud, This monster takes the form of a cloud in the sky.'),
    (5,9,'Corpse, This monster takes the form of a corpse, and counts as a corpse in all death calculations, even while alive.'),
    (5,10,'Demon, With demonic horns and evil eyes, this monster is not to be trusted.'),
    (5,11,'Disease, Sickness and plague follow wherever this monster goes.'),
    (5,12,'Dragon, this monster takes the form of a great dragon, with potent breath, wings and claws.'),
    (5,13,'Elf, Mischevious and tricky, this monster takes the form of an elf.'),
    (5,14,'Fish, Happier in water, this monster resembles a fish, and prefers the depths.'),
    (5,15,'Fox, Small, clever and mischevious, this monster resembles a fox spirit, and may attempt to trick you.'),
    (5,16,'Frog, This wily amphibious monster prefers a humid climate and may have special powers when kissed by a princess.'),
    (5,17,'Gem, This monster resembles a large expensive Gem with a powerful soul trapped inside.'),
    (5,18,'Ghost, This frightening monster feels cold when you pass through it.'),
    (5,19,'Golem, This monster resembles a moving statue.'),
    (5,20,'Horse, Fast and furious, this horse can be ridden, but only by those that care for it.'),
    (5,21,'Humanoid, This monster is vaguely human shaped, with a head, two arms and two legs.'),
    (5,22,'Jellyfish, This monster is a bell of jelly with a long potentially poisonous tail it uses to capture its prey.'),
    (5,23,'Light Blob, This monster is best described as a blob of light.'),
    (5,24,'Lizard, This monster is scaled and cold blooded.'),
    (5,25,'Monk, This monster resembles a holy monk.'),
    (5,26,'Penguin, A member of the royal family, this penguin either has serfs and land or is in line to inherit it.'),
    (5,27,'Plant, This monster is definately more flora than fauna, and feeds by drinking water in its roots and sunlight in its leaves.'),
    (5,28,'Raptor, These monsters are shaped like veloceraptors, with heads that bite and claws that slash.'),
    (5,29,'Rat, these disgusting little rodents carry all sorts of disease .'),
    (5,30,'Scavenger, These vultures eat corpses, and can sense death. When they do, they circle above, waiting for their next meal.'),
    (5,31,'Scorpion, Native to deserts and darkness, these plated insects have poisonous stingers and vicious claws.'),
    (5,32,'Snake, These limbless reptiles are known to wind their bodies around prey to squeeze the life out of them. Their fangs are deadly poison, and nothing escapes thier slitted souless eyes.'),
    (5,33,'Soldier, These humaniod monsters are equipped in armor, swords and shields.'),
    (5,34,'Sphynx, These sentient cats have the head of a man, and speak in riddles.'),
    (5,35,'Squid, This monster dwells in the deep. Their squishy body ripples with muscles, and they are ferocious protectors of the depths.'),
    (5,36,'Starfish, This star shaped monster clings to stones in the depths of the ocean, eating small animals underneath it.'),
    (5,37,'Steam Blob, Made entirely of steam, this blob shaped monster dwells in hot caverns deep in the earth.'),
    (5,38,'Stone, This monster is made entirely of stone.'),
    (5,39,'Sword, This monster is a master of the sword.'),
    (5,40,'Symbol, This monster embodies a symbolic representation of a concept.'),
    (5,41,'Tree, This monster is a tree.'),
    (5,42,'Turtle, This monster has a large shell it can hide in in a moments notice.'),
    (5,43,'Tyrant, This monster resembles a tyrannosaurous rex.'),
    (5,44,'Wasp, This monster resembles a flying insect with a stinger.'),
    (5,45,'Wolf, This monster resembles a canine.'),
    (5,46,'Liquid, This monstetr is a sentient liquid.'),
    (5,47,'Cow, This monster resembles a bovine.'),
    (5,48,'Spider, this poisous monster has 8 legs and many eyes.'),
...
VALUES
(1,1,1),(1,2,1),(1,3,6),(1,6,0),(1,7,0),(1,9,1),(1,10,1),(1,41,1),
(2,1,1),(2,2,2),(2,3,21),(2,6,2),(2,7,0),(2,9,2),(2,10,1),(2,18,1),(2,41,2),
(3,1,1),(3,2,2),(3,3,15),(3,6,0),(3,7,0),(3,9,1),(3,20,1),(3,21,1),(3,41,1),
(4,1,1),(4,2,2),(4,3,40),(4,6,0),(4,7,0),(4,9,1),(4,20,1),(4,21,1),(4,41,1),
(54,1,1),(54,2,3),(54,3,10),(54,6,-1),(54,7,4),(54,12,-3),(54,20,2),(54,31,2),
(55,1,1),(55,2,4),(55,3,10),(55,6,4),(55,7,1),(55,12,-4),(55,13,2),(55,18,3),(55,31,3),
(56,1,1),(56,2,4),(56,3,10),(56,6,-2),(56,7,4),(56,12,-4),(56,14,2),(56,20,3),(56,31,3),
(57,1,3),(57,2,1),(57,3,37),(57,6,0),(57,7,0),(57,49,1),
(58,1,3),(58,2,2),(58,3,37),(58,6,0),(58,7,0),(58,18,1),(58,49,2),
(59,1,3),(59,2,2),(59,3,37),(59,6,0),(59,7,0),(59,20,1),(59,49,2),
(60,1,3),(60,2,3),(60,3,37),(60,6,0),(60,7,0),(60,9,1),(60,18,2),(60,49,3),
(61,1,3),(61,2,3),(61,3,37),(61,6,0),(61,7,0),(61,9,2),(61,20,2),(61,49,3),
(62,1,3),(62,2,4),(62,3,37),(62,6,0),(62,7,0),(62,9,2),(62,12,-1),(62,18,3),(62,49,4),
(63,1,3),(63,2,4),(63,3,37),(63,6,0),(63,7,0),(63,9,3),(63,20,3),(63,49,4),
(64,1,1),(64,2,1),(64,3,14),(64,6,1),(64,7,6),(64,35,1),
(65,1,1),(65,2,2),(65,3,14),(65,6,2),(65,7,6),(65,8,1),(65,9,-1),(65,18,1),(65,35,2),
(66,1,1),(66,2,2),(66,3,14),(66,6,2),(66,7,6),(66,8,1),(66,9,-1),(66,19,1),(66,35,2),
(67,1,1),(67,2,2),(67,3,40),(67,6,1),(67,7,6),(67,8,1),(67,9,-1),(67,20,1),(67,22,1),
(68,1,1),(68,2,3),(68,3,14),(68,6,2),(68,7,6),(68,8,2),(68,9,-2),(68,13,1),(68,18,2),(68,35,3),
(69,1,1),(69,2,3),(69,3,14),(69,6,2),(69,7,6),(69,8,2),(69,9,-1),(69,19,2),(69,29,1),(69,35,3),
(70,1,1),(70,2,3),(70,3,38),(70,6,2),(70,7,6),(70,9,-1),(70,16,1),(70,17,1),(70,19,1),(70,20,1),(70,22,1),(70,34,1),
(71,1,1),(71,2,3),(71,3,40),(71,6,2),(71,7,6),(71,9,-2),(71,13,-1),(71,14,1),(71,20,2),(71,22,2),(71,24,1),(71,25,1),
(72,1,1),(72,2,4),(72,3,12),(72,4,14),(72,6,5),(72,7,6),(72,8,3),(72,9,-2),(72,13,2),(72,16,1),(72,18,3),(72,35,4),
(73,1,1),(73,2,4),(73,3,14),(73,6,5),(73,7,6),(73,8,3),(73,9,-2),(73,15,-1),(73,16,1),(73,19,3),(73,35,4),
(74,1,1),(74,2,4),(74,3,17),(74,6,3),(74,7,6),(74,9,-2),(74,16,2),(74,17,2),(74,19,2),(74,20,2),(74,22,2),(74,34,2),
(75,1,1),(75,2,4),(75,3,40),(75,6,3),(75,7,6),(75,9,-2),(75,13,-2),(75,14,3),(75,20,3),(75,21,1),(75,22,3),(75,23,1),(75,24,1),(75,25,1),(75,26,1),
...
(171,1,4),(171,2,2),(171,3,11),(171,6,0),(171,7,0),(171,11,-1),(171,20,1),(171,50,2),
...
(231,1,3),(231,2,1),(231,3,23),(231,6,0),(231,7,2),(231,10,1),(231,11,1),
