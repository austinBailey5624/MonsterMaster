...
VALUES
    ...
    ('Onyx','A mesmerizing blak gem, can be consumed to greatly improve relatonships with dark monsters and Gods',55,50,'Gain affinity with Enemy and Umbral Monsters','60% drop from Onyx, 5% drop from Vulcanous','USEABLE');
