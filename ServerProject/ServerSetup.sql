...
VALUES
 ...
 CREATE TABLE deity(
  ...
  VALUES
    ...
    CREATE TABLE deity_description(
		deity_description_id INT PRIMARY KEY AUTO_INCREMENT,
        deity_id INT NOT NULL,
        FOREIGN KEY(deity_id) REFERENCES deity(deity_id),
        description VARCHAR(1000) NOT NULL
        );
        
	INSERT INTO deity_description(deity_id,description)
    VALUES
        ...
        (14,'Mars is the God of war, fire, blood, power, authority and conflict. He is capricious, one day using authority, the other day using his sword.'),
        (15,'Thanatos is the god of Death, who ferries souls from the mortal plane to the underworld. He is called \'victor\' by is servants, for he alone will be the final victor when all cross his gate.'),
...
VALUES
    ...
    ('Fire Opal',0,NULL,11,NULL,4,'A sentient red and orange stone, the is an enchanted rock that hovers at chest level. Large as a big pot, they are known for their fierce loyalty to their masters, as well as their unquenchable heat.'),
    ...
    ('Bolide',0,NULL,NULL,NULL,6,'When Comets have been consumed by their anger, they form into a Bolides, huge comets whose speed only ceases at their deaths. Its very speed ignites the air, burning all in its path.'),
    ...
    ('Jelly',15,114,NULL,115,108,'The jelly is a small translucent purple magical fish that is bell-shaped and floats around. It seems to have a different kind of consciousness and understanding. It is incredibly poisonous, and wraps its tail around its enemies to sting them'),
    ...
    ('Sticket',21,131,132,133,NULL,'The Sticket pretends to be magical but isn\'t. Its very depressing huh? Its basically just a small stick that can move on its own. But its very good at listening, probably because it can\'t talk. If it could though it would always advise revenge by saying \'Sticket to em!\''),
    ...
    ('Pegasus',23,NULL,159,NULL,155,'Pegasus is glad that its no longer a lesser pegasus, because lets face it, those teenage years sucked. Now he can fly but he can\'t carry anyone. Especially heroes in armor. Are you kidding me? Its already aerodynamically impossible for a horse to fly and now you want to add a two hundred pound hero with 300 pounds of armor? not to mention loot? Not on my back.'),
    ...
    ('Flapper',33,200,201,202,NULL,'The Flapper shows a ridiculous amount of leg, especially for this time period. It is very stylish, and wears a headband with a feather on it, even though its already a bird. Ever the shy ones, flappers keep the roof of their shells as a helmet to hide in.'),
    ...
    ('Baldgul',33,NULL,207,NULL,200,'The Baldgul is a bald eagle that is actually bald. Not white feathers, no feathers. It is terribly embarrassed because all of its birdy friends still have their feathers, but the toupee wasn\'t working anymore, so they took their baldness in stride.'),
    ...
    ('Wiseowl',35,NULL,230,NULL,224,'The wisdom of this owl is evident in its large eyes, for he who increaseth knowledge increaseth sorrow. You will experience some of that sorrow if you seek to outsmart this beast, as it is one of the cleverest shadow magic users in existence.'),
    ...
    ('Knowlowlegabel',35,NULL,NULL,NULL,227,'The Knowlowlegabel knows only that it does not know. It can cast logical contradiction that injures monsters scaling with their intellect. It can use its knowledge of psychology to manipulate its enemies, often making its prey come right to it.'),
    ...
    ('Diurnal',40,NULL,236,NULL,231,'A diurnal is a monster that is active only during the day. It looks like a saur made of flames, at least in the sunlight. During nighttime, its flames extinguish and it is weakened.'),
    ...
    ('Flarewolf',40,NULL,238,NULL,232,'A FlareWolf is a glowing wolf that can breathe a solar flare. It shines brightly during the day, and is strongest during the noon hour. Conversely, it is weaker at night, especially midnight.'),
    ...
    ('Guardanius',42,NULL,NULL,NULL,251,'The Guardanius is a stone titan with a large amount of HP. He can cast a skill on a unit so that the Guardanius dies instead of them when they are killed, transferring hp.'),
    ...
    ('Semiangel',43,NULL,259,NULL,255,'The Semiangel can anoint light primary allies, buffing their attack by 20%. It takes the form of a small child with four wings.'),
    ...
    ('Ascendenphage',44,NULL,NULL,NULL,266,'The Ascendenphage is a lage Argenphage whose armor glows a brilliant white, made of some opaque white metal, the symbols etched into the metal are likewise fancy. It is the supreme guardian of all things holy.'),
    ...
    ('Slyther',51,NULL,299,NULL,294,'The Slyther is a small snake that slides through the grass towards its prey. Its bite is venomous. Its green and has no rattle. It is quiet, and slow- quick only at the moment it strikes. Most of its victims never knew it was there until it was too late.'),
...
VALUES
    ...
    (3,17,'Elf, Mischievous and tricky, this monster takes the form of an elf.'),
    ...
    (3,20,'Fox, Small, clever and mischievous, this monster resembles a fox spirit, and may attempt to trick you.'),
    ...
    (3,41,'Snake, These limbless reptiles are known to wind their bodies around prey to squeeze the life out of them. Their fangs are deadly poison, and nothing escapes their slitted souless eyes.'),
    ...
    (4,17,'Elf, Mischievous and tricky, this monster takes the form of an elf.'),
    ...
    (4,20,'Fox, Small, clever and mischievous, this monster resembles a fox spirit, and may attempt to trick you.'),
    ...
    (4,41,'Snake, These limbless reptiles are known to wind their bodies around prey to squeeze the life out of them. Their fangs are deadly poison, and nothing escapes their slitted souless eyes.'),
    ...
    (5,17,'Elf, Mischievous and tricky, this monster takes the form of an elf.'),
    ...
    (5,20,'Fox, Small, clever and mischievous, this monster resembles a fox spirit, and may attempt to trick you.'),
    ...
    (5,41,'Snake, These limbless reptiles are known to wind their bodies around prey to squeeze the life out of them. Their fangs are deadly poison, and nothing escapes their slitted souless eyes.'),
    ...
    (11,-5,'This monster is very attuned to the nighttime, dealing 15% additional damage during night, however it recieves 5% additional damage during the day.'),
    ...
    (11,0,'This monster prefers neither nighttime nor daytime.'),
    ...
    (17,-8,'This monster has vowed poverty. While its in your party, you gain wealth at 20% the usual rate, and it gains 20% bonus experience.'),
    (17,-7,'This monster has vowed poverty. While its in your party, you gain wealth at 30% the usual rate, and it gains 17.5% bonus experience.'),
    (17,-6,'This monster has vowed poverty. While its in your party, you gain wealth at 40% the usual rate, and it gains 15% bonus experience.'),
    (17,-5,'This monster has vowed poverty. While its in your party, you gain wealth at 50% the usual rate, and it gains 12.5% bonus experience.'),
    (17,-4,'This monster has vowed poverty. While its in your party, you gain wealth at 60% the usual rate, and it gains 10% bonus experience.'),
...
(76,1,1),(76,2,1),(76,3,19),(76,4,21),(76,6,1),(76,7,6),(76,8,1),(76,35,1),
(77,1,1),(77,2,2),(77,3,53),(77,6,2),(77,7,6),(77,15,-2),(77,16,2),(77,18,1),(77,35,1),
(78,1,1),(78,2,2),(78,3,21),(78,6,1),(78,7,6),(78,8,2),(78,19,1),(78,35,1),(78,45,1),
(79,1,1),(79,2,2),(79,3,21),(79,6,0),(79,7,6),(79,8,2),(79,17,-1),(79,20,1),(79,35,1),
(80,1,1),(80,2,3),(80,3,53),(80,6,3),(80,7,6),(80,13,1),(80,14,-1),(80,15,-3),(80,16,3),(80,18,2),(80,35,1),
(81,1,1),(81,2,3),(81,3,21),(81,6,1),(81,7,6),(81,8,3),(81,19,2),(81,35,1),(81,45,2),
(82,1,1),(82,2,3),(82,3,21),(82,6,0),(82,7,6),(82,8,3),(82,13,-1),(82,14,1),(82,17,-2),(82,20,2),(82,22,1),(82,23,1),(82,35,1),
(83,1,1),(83,2,4),(83,3,53),(83,6,5),(83,7,6),(83,13,3),(83,14,-3),(83,15,-4),(83,16,4),(83,18,3),(83,35,1),
(84,1,1),(84,2,4),(84,3,21),(84,6,1),(84,7,6),(84,8,4),(84,19,3),(84,35,1),(84,45,3),
(85,1,1),(85,2,4),(85,3,21),(85,6,0),(85,7,6),(85,8,4),(85,13,-3),(85,14,2),(85,17,-3),(85,20,3),(85,22,2),(85,23,2),(85,35,1),
(86,1,3),(86,2,1),(86,3,11),(86,6,0),(86,7,0),(86,28,1),
(87,1,3),(87,2,2),(87,3,11),(87,4,41),(87,6,-1),(87,7,0),(87,18,1),(87,28,2),
(88,1,3),(88,2,2),(88,3,11),(88,4,47),(88,6,-1),(88,7,0),(88,19,1),(88,28,2),
(89,1,3),(89,2,2),(89,3,11),(89,6,-1),(89,7,0),(89,9,-1),(89,20,1),(89,28,2),
(90,1,3),(90,2,3),(90,3,11),(90,4,41),(90,6,-2),(90,7,0),(90,13,1),(90,18,2),(90,28,3),
(91,1,3),(91,2,3),(91,3,11),(91,6,-2),(91,7,0),(91,16,1),(91,19,2),(91,28,3),
(92,1,3),(92,2,3),(92,3,11),(92,4,53),(92,6,-2),(92,7,0),(92,9,-2),(92,14,1),(92,20,2),(92,28,3),
(93,1,3),(93,2,4),(93,3,11),(93,4,16),(93,6,-3),(93,7,0),(93,13,2),(93,15,2),(93,18,3),(93,28,4),
(94,1,3),(94,2,4),(94,3,11),(94,4,33),(94,6,-3),(94,7,0),(94,8,2),(94,16,2),(94,19,3),(94,28,4),
(95,1,3),(95,2,4),(95,3,11),(95,6,-3),(95,7,0),(95,9,-3),(95,14,2),(95,20,3),(95,28,4),
(96,1,1),(96,2,1),(96,3,7),(96,6,1),(96,7,5),(96,9,-1),
(97,1,1),(97,2,2),(97,3,20),(97,6,1),(97,7,3),(97,9,-2),(97,15,1),(97,18,1),
(98,1,1),(98,2,2),(98,3,34),(98,6,3),(98,7,6),(98,9,-2),(98,17,1),(98,19,1),(98,35,1),(98,36,1),
(99,1,1),(99,2,2),(99,3,14),(99,6,2),(99,7,3),(99,9,-2),(99,16,-1),(99,20,1),
(100,1,1),(100,2,3),(100,3,56),(100,6,3),(100,7,3),(100,9,-3),(100,13,1),(100,15,1),(100,18,2),
(101,1,1),(101,2,3),(101,3,34),(101,6,3),(101,7,6),(101,9,-3),(101,17,2),(101,19,2),(101,35,2),(101,36,1),
(319,1,3),(319,2,4),(319,3,11),(319,4,14),(319,6,0),(319,7,0),(319,12,-2),(319,15,3),(319,19,3),(319,28,3),
(320,1,3),(320,2,4),(320,3,11),(320,4,14),(320,6,0),(320,7,0),(320,9,-3),(320,13,-2),(320,16,-1),(320,20,3),(320,22,2),(320,24,2),(320,28,3),
(321,1,1),(321,2,1),(321,3,1),(321,4,14),(321,6,0),(321,7,3),(321,40,1),
(322,1,1),(322,2,2),(322,3,1),(322,4,14),(322,6,-2),(322,7,3),(322,18,1),(322,40,2),(322,42,1),
(323,1,1),(323,2,2),(323,3,1),(323,4,14),(323,6,1),(323,7,3),(323,14,1),(323,20,1),(323,40,2),
(324,1,1),(324,2,3),(324,3,1),(324,4,14),(324,6,4),(324,7,3),(324,18,2),(324,40,3),(324,42,2),
(325,1,1),(325,2,3),(325,3,1),(325,4,14),(325,6,-3),(325,7,3),(325,14,2),(325,20,2),(325,40,3),
(326,1,1),(326,2,4),(326,3,1),(326,4,14),(326,6,-3),(326,7,3),(326,18,3),(326,40,4),(326,42,3),
(327,1,1),(327,2,4),(327,3,1),(327,4,14),(327,6,3),(327,7,3),(327,14,3),(327,20,3),(327,40,4),
(328,1,5),(328,2,1),(328,3,14),(328,6,0),(328,7,3),(328,10,-1),(328,42,1),
(329,1,1),(329,2,2),(329,3,14),(329,4,26),(329,6,2),(329,7,3),(329,10,-2),(329,13,1),(329,18,1),(329,40,1),(329,42,2),
(330,1,1),(330,2,2),(330,3,14),(330,4,20),(330,6,2),(330,7,3),(330,10,-2),(330,11,-1),(330,19,1),(330,40,1),(330,42,1),
(331,1,1),(331,2,2),(331,3,51),(331,6,0),(331,7,3),(331,10,-2),(331,20,1),(331,26,1),(331,40,1),(331,42,2),
(332,1,1),(332,2,3),(332,3,14),(332,4,26),(332,6,4),(332,7,3),(332,10,-3),(332,13,1),(332,15,1),(332,18,2),(332,40,2),(332,42,3),
...
INSERT INTO skill(skill_name, skill_description, cost_mp, nature, tier, unlock_requirement_manager_id, usage_requirement_manager_id)
     ...
     ('Shine Badge','Shine your badge, empowering yourself with authority and light, deal a small amount of light damage to everyone',4,'Magical',1.0,8,8),
     ('Suck Blood','Attempt to bite an enemy, dealing a small amount of damage, healing yourself for the amount',4,'None',1.0,9,9),
     ('Peck','Poke an enemy with your beak, dealing air and physical damage',0,'Physical',1.0,10,10),
     ('Hibernate','Heal yourself, and put yourself to sleep',0,'None',1.0,11,11),
     ('Flap','Buffet your opponent with a gust of wind',0,'None',1.0,12,12),
     ('Silver Bubble','Send a silver bubble at your opponent',0,'Magical',1.0,13,13),
...
VALUES
    ...
    ('Charcoal','Burnt wood perfect for starting a fire, can be used to slightly heal an immolated monster, or consumed to slightly reduce poisoning',0,1,'Heal an immolated monnster for 1d4, and heal target 1 point of poison damage','Base 30% dro from Flarial, 60% Drop from Pyrus, Flarpup and Pyro Symbol.','USEABLE'),
    ('Warm Scale','Warm Scale from a fire lizard, can be used to moderately increase temperature. Damages Monsters accustomed to cold, and heals those accustomed to heat.',0,2,'Damage a cold monster 1d4, or heal a warm one 1d4, regardless, increase temperature by 3','30% drop from Pyrus, 60% drop from Pyos, 90% drop from Pyres','USEABLE'),
    ('Red Dragon Scale','Hot scale from a red dragon, can be used to dramatically increase temperature, damage a cold monster, or heal a hot one.',0,10,'Damage a cold monster 1d8 or heal a warm one 1d8, regardless increase temperature by 10 points','Base 10% drop from Pyos, 30% drop from Pyres.','USEABLE'),
    ...
    ('Salamander Skin','Heals the frozen status condition',2,5,'Use on a target to heal the frozen status','30% drop from salamander','USEABLE'),
    ('Raptor Claw','Deals minor physical damage to a target',2,7,'deal 1d4 Physical damage on Target','30% drop from Raptor, 50% drop from Tyrant, 70% drop from Great White Typrant','USEABLE'),
    ...
    ('Rough Hide','Increase physcial defense of target for the rest of the battle',2,5,'Increase target\'s physical defense by 1 for the rest of the battle','30% drop from Herbisaur, 50% drop from Spikevorsaur, 70% drop from Broncheospikesaur','USEABLE'),
    ('Thorny Hide','Target reflects a small amount of physical damage for the rest of the battle',2,15,'Target reflects 1 point of physcial damage for the rest of the battle','30% drop from Spikevorsaur, 50% drop from Broncheospikesaur','USEABLE'),
    ('Spiked Hide','Target reflects and is protected from some physical damage for the rest of the battle',2,25,'Target reflects 2 points of physical damage, and increases their physical damage protection by 2 for the rest of the battle','30% drop from Broncheospikesaur','USEABLE'),
    ('Kangarat Tail','Target is more resistant to heat for the rest of the battle',3,1,'Target has one higher \'heat\' trait until the end of the battle (max 4)','30% drop from kangarat','USEABLE'),
    ('Slynx Collar','When equipped, increases the users heat tolerance',3,10,'When equipped, increases heat tolerance by 1','30% drop from Slynx','ACCESSORY'),
    ('Sphynx Eye','Target takes a small amount of magic, fire and air damage',3,15,'Target takes 1d4 magic, fire and air damage','30% drop from a sphynx, 50% drop from a greater sphynx','USEABLE'),
    ('Sphynx Claw','Target takes a small amount of physical damage, and deals increased sand magic for the rest of the battle',3,22,'Target takes 1d4 physical, then Sand Magic intensity increased by 1 for the rest of the battle','30% drop from a Greater Sphynx','USEABLE'),
    ('Scoprion Stinger','Inflicts small amount of poison on a target',3,4,'Target takes 1 point of poison damage','30% drop from Skorpi, 50% drop from Scarpi, 70% drop from Scorpious, 20% drop from Stinger','USEABLE'),
    ('Red Scorpion Stinger','Inflicts poison on a target',3,8,'Target takes 2 points of poison damage','30% drop from Scarpi, 50% drop from Scorpius','USEABLE'),
    ('Golden Scorpion Stinger','Inflicts a large amount of poison on a target',3,16,'Target takes 4  points of poison damage','30% drop from Scorpius','USEABLE'),
    ('Clean Water','Heals a small amount of health and mana',3,5,'Target heals 1 point of health and mana','30% drop from humpless, 50% drop from Unihump, 70% drop from bihump','USEABLE'),
    ('Oasis Water','Heals health and mana',3,15,'Target heals 2 points of health and mana','30% drop from Unihump, 50% drop from Bihump','USEABLE'),
    ('Sacred Oasis Water','Heals health and mana',3,25,'Target heals 3 points of health and mana','30% drop from Bihump','USEABLE'),
    ('White Demon Horn','Deal small amount of physical and light damage to target',4,1,'Target takes 1 point of physical and 1 point of Light damage','30% drop from Angier, 50% drop from Justicar, 70% drop from Ordinator, 90% drop from Zireal','USEABLE'),
    ('Wooden Buclker','When equipped, raise physical defense by a small amount',4,10,'Raise Physical defense by 1 when equipped','30% drop from Justicar','ACCESSORY'),
    ('Steel Shield','When equipped, raise physical defense by a moderate amount',4,20,'Raise Physical defense by 2 when equipped','30% drop from Ordinator','ACCESSORY'),
    ('Ahros Paladin\'s Shield','When equipped raise physical defense by a moderate amount, and fire defense by a small amount',4,35,'Raises Physical defense by 2 and fire defense by 1 when equipped','30% drop from a Zireal','ACCESSORY'),
    ('Red Angel Down','Consume as a sacrement to Ahros and slightly strengthen Justice Monsters',4,8,'Consume to increase affinity with Ahros and the Justice Element by 1','30% drop from Ayurved, 50% drop from Anyr,70% drop from Justicer','USEABLE'),
    ('Red Angel Feather','Consume as a ritural to Ahros, and strengthen Justice Monsters',4,16,'Consume to increase affinity with Ahros and the Justice Element by 2','30% drop from Anyr, 50% drop from Justicer','USEABLE'),
    ('Red Angel Wing','Consume with devotion to Ahros, and greatly strengthen Justice Monsters.',4,24,'Consume to increase affinity with Ahros and the Justice Element by 3','30% drop from Justicer','USEABLE'),
    ('Red Demon Horn','Deal a small amount of physical and fire damage to target',5,1,'Target takes 1 point of physical damage and 1 point of Fire damage','30% drop from Spiten, 50% drop from Jacobia and Lizbet, 70% drop from Lethanm and D\'hoffry, 90% drop from Revenant and Halfrec','USEABLE'),
    ('Goat\'s Mane','An accessory from an evil demonic goat granting a small amount of protection from darkness and physical damage',5,5,'Equip to gain protection from physcial by 1 and darkness by 1','30% drop from Jacobia, 50% drop from Letham','ACCESSORY'),
    ('Demon Bull\'s Horn','Deal a moderate amount of physical and fire damage to a target',5,9,'Deal 1d4 physical and 1d4 fire damage to a target','30% drop from Letham, 50% drop from Revenant','USEABLE'),
    ('Demon Whip','Formed from a Revenant\'s tail, this quick and agile weapon will deal small amounts of damage to targets in great range',5,25,'Deal 1d4 fire, darkness, and physical on strike, quick attack','30% drop from Revenant','WEAPON'),
    ('Lock of Red Demon Hair','Consume to slightly increase darkness, fire, and magic damage for the remainder of the battle',5,6,'Add 1 point of fire, darkness, and magic damage to magic attacks for the remainder of the battle','30% drop from Lizbet, 50% drop from D\'hoffry, 70% drop from Halfrec','USEABLE'),
    -- D'hoffry's base unique item drop is black angel feather in the betrayer element
    ('Lock of Ancient Red Demon Hair','Consume to increase darkness, fire and magic damage for the rest of the battle',5,25,'Add 1d4 points of fire, darkeness, and magic damage for the rest of the battle','30% drop from Halfrec','USEABLE'),
    ('Steam Bubble','Throw at an enemy to deal water and fire damage to it, and increase the the heat of the battlefield',10,2,'deal 1 point of fire, water damage, increase heat by 1 point','30% drop from Minor Steamlet, 50% drop from Lesser Steamlet and Scaldar, 70% drop from Steamlet and Excoriator, 90% drop from greater steamlet and Meldor','USEABLE'),
    ('White Phosphorus','Throw at a target to deal water and fire damage to it, or heal that target if it is of the steam element',10,5,'deal 1 point of fire, water and physical damage, or heal 1d8 if of the steam element','30% drop from Les-- ser Steamlet, 50% drop from Steamlet, 70% drop from greater steamlet','USEABLE'),
    ('Yellow Phosphorus','Throw at a target to deal a moderate amount of water and fire damage to it, or heal that target by a moderate amount if it is of the steam element',10,12,'deal 2 points of fire water and physical damage, or heal by 2d6 if of the steam element','30% drop from Steamlet, 50% drop from greater steamlet','USEABLE'),
    ('Red Phosphorus','Throw at a target to deal a large amount of water and fire damage, or heal that target by a large amount if it is of the steam element',10,18,'deal 3 points of fire and water and physical damage, or deal by 3d8 if it is of of the steam element','30% drop from greater steamlet','USEABLE'),
    ('Hot Steam Bubble','Throw at an enemy to deal fire, water, heat, and wet damage to it, moderately increase the heat of the battlefield',10,5,'Deal 2 points of fire, water, heat and wet damage, increase heat by 2 points','30% drop from Scaldar, 50% drop from Excoriator, 70% drop from Meldor','USEABLE'),
    ('Steam Grenade','Throw at a target to deal a moderate amount of fire, water, magic, heat and wet damage to it, moderately increase the heat of the battlefield',10,10,'Deal 3 points of fire, water, magic, heat, and wet damage, increase heat by 3 points','30% drop from Excoriator, 50% drop from Meldor','USEABLE'),
    ('Steam Bomb','Damage every participant in the battle for a large amount of fire, water, magic, heat and wet damage, and greatly increase the heat of the battlefield',10,25,'Deal 4 points of fire, water, magic, heat and wet damage, increase heat by 5 points to every participant in battle,','30% drop from Meldor','USEABLE'),
    ('Fish Scale','Slightly Increase target protection from water until end of battle',11,2,'Increase Water protection by 1 until end of battle','30% drop from Minnow, 50% drop from EdgeFin and Cuddlerfish, 70% drop from SliceFin and Snugglerfish, 90% dro from Blue Dragon and Leviathan, 30% drop from Gullfish, Skipfish, Flyfish and Soarfish','USEABLE'),
    ('Sharp Fin','Use to deal water and physical damage to target',11,5,'Deal 1 point of water and physical damage to target','30% drop from Edgefin, 50% drop from Slicefin, 70% Blue Dragon','USEABLE'),
    ('Shark Tooth','Use to deal moderate water and physical damage to target',11,10,'Deal 2 points of water and physical damage to target','30% drop from Slicefin, 50% drop from Blue Dragon','USEABLE'),
    ('Blue Dragon Fang','Equip to increase water and physical damage',11,25,'Raise physical and water damage by 1 when equipped','30% drop from a blue dragon','USEABLE'),
    ('Tear','Use on target to inflict Wet status effect',11,5,'Deal 2 points of wet status effect','30% drop from cuddlerfish, 50% drop from Snugglerfish','USEABLE'),
    ('Lover\'s tear','Use on target to inflict a large amount of wet status effect, water, and magic damage',11,15,'Deal 4 point of wet status effect, 2 points of water and magic damage','30% drop from snugglerfish','USEABLE'),
    ('Sea Monster Soul','Equip to increase water and wet status damage',11,22,'Raise water and wet damage by 1 when equipped','30% drop from a Leviathan','ACCESSORY'),
    ('Blue Coin','Heal MP of blue primary monster or consume for an increase in affinity with the Aqua Element',11,10,'Heal MP of target by 10 points if primary nature is Water, gain 1 point of affinity with Aqua element and Neptune if consumer is player','30% drop from Aqua Symbol, 40% drop from Aqua Lemental, 25% drop from aqua elmeental, aero elemental, and luxor elemental, 60% drop from primordial aqua elemental, and 20% drop froma all primordial elementals','USEABLE'),
    ('Torquoise','Blue Green stone used in jewelry making. Can be cracked open to gain affinity with water gods and monsters',11,20,'Gain affinity with Neptune and Aqua Monsters','Base 50% drop from Torquoise, 70& drop from Sapphire, 10% drop from Slynx, 15% drop from Sphinx, 20% drop from Greater Sphynx','USEABLE'),
    ('Sapphire','A dazzling blue stone used in jewelry making. Can be cracked open to gain affinity with water gods and monsters',11,50,'Gain affinity with Neptune and Aqua Monsters','Base 60% drop from Sapphire','USEABLE'),
    ('Tapple Tail','A tail of a tadpole becoming a frog, deals minor water damage to target',12,1,'Deal 1 point of water damage to target','30% drop from Tapple','USEABLE'),
    ('Turtle Shell','Protect target by a moderate amount of physical and water damage until end of battle',12,5,'Target gains 2 points of defense from physical and water','30% drop from hider, 50% drop from Snapper, 70% drop from Crusheller','USEABLE'),
    ('Snapper Beak','Use to deal moderate physical and water damage to a target',12,10,'Deal 2 points of Water and Physical Damage to Target','30% drop from Snapper, 50% drop from Crusheller','USEABLE'),
    ('Crushing Shell','Equip to greatly increase physical protection, and reduce speed',12,25,'Raise Physical Protection by 10 and mulitply base speed by .2 when equipped','30% drop from Crusheller','USEABLE'),
    ('Rainbow Slime','Deal 1 point of a random status to target',12,6,'Randomly select a staus and deal 1 point of that status to target','30% drop from Rainbow Frog, 50% drop from Frogaudy, 70% drop from Frogealer','USEABLE'),
    ('Angry Rainbow Slime','Deal 2 points of a random negative status effect to target',12,12,'Randomly select a negative status and deal 2 points of that status to target','30% drop from Frogaudy, 50% drop from Frogealer','USEABLE'),
    ('Magic Rainbow Slime','Deal 3 points of a positive random status effect to target ally, or 3 points of negative random status effect to target enemy',12,22,'If target is an ally, randomly select a positive status effect and deal 3 damage of it, if target is an enemy, randomly select a negative status effect and deal 3 damage of it','30% drop from frogealer,','USEABLE'),
    ('Toad Hide','Target gains a small amount of protection from water, earth, and magic for the remainder of the battle',12,4,'Add 1 point of defense of Water, Earth and Magic until end of battle','30% drop from Frogami, 50% drop from Esotoad, 70% drop from Metitode','USEABLE'),
    ('Magic Toad Hide','Target gains a small amout of protection from water, earth and magic, and a small increase to water, earth, and magic damage for the rest of the battle',12,12,'Add 1 point of defense for Water, Earth and Magic, and one point of defense for water, earth and magic','30% drop from Esotoad, 50% drop from Metitode','USEABLE'),
    ('Magic Toad Soul','Equip to increase Earth and Water Magic power',12,25,'Raise Water and Earth Magic power by 1 while equippped','30% drop from Metitode','ACCESSORY'),    
    ('shocking ram\'s horn','Use to deal a small amount of lightning damage to a target',13,1,'Deal 1 point of air damage to a target','30% drop from cirrus','USEABLE'),
    ('Lightning in a bottle','Use to deal lightning damage to a target',13,5,'Deal 2 points of air damage to a target','30% drop from Cumulus, 50% drop from Nephol, 70% drop from Thunderus','USEABLE'),
    ('Lightning snake fang','Use to deal lightning and physical damage to a target',13,10,'Deal 2 points of air damage to a target, and 2 points of physical damage to a target','30% drop from Nephol, 50% drop from Thunderus','USEABLE'),
	('Lightning dragon fang','Equip to increase lightning and physical damage',13,35,'Raise physical and air damage by 1 when equipped','30% drop from Thunderus','USEABLE'),
    ('Wet Deer Antler','Use to deal a small amount of water, wet and physical damage',13,5,'Deal 1 point of water, 1point of wet, and 1 point of physical damage','30% drop from Stratus, 50% drop from cumulostratus, 70% drop from ccirricumulus','USEABLE'),
    ('Wet Elk Antler','Use to deal water, wet and physical damage',13,10,'Deal 2 points of water, wet and physical damage','30% drop from cumulostratus, 50% drop from cirricumulus','USEABLE'),
    ('Wet Moose Antler','Use to deal substantial water, wet and physical damage',13,20,'Deal 3 points of water, wet and physical damage','30% drop from cirricumulus','USEABLE'),
    ('Cold Shell','Use to add a small amount of cold and physical protection',13,5,'Target gains 1 point of physical protection, and remove 1 point of heat from battle','30% drop from Nimbus, 50% drop from Nimbuloponderant, 70% drop from Cumulonimbus','USEABLE'),
    ('Icy Shell','Use to add cold and physical protection',13,10,'Target gains 2 points of physical protection, remove 2 points of heat from battle','30% drop from Nimbuloponderant, 50% drop from cumulonimbus','USEABLE'),
    ('Frozen Shell','Use to add substantial cold and physical protection',13,20,'Target gains 3 points of physical protection, remove 3 points of heat from battle','30% drop from cumulonimbus','USEABLE'),
    ('snowball','Use to deal a small amount of cold damage',14,1,'Target takes 1 point of cold damage,','30% drop from Snoball, 50% drop from Fauxice, Princeguin, and Icebreaker, 70& drop from Freki, Kinguin, White Limper, and Ice Witch, 90% drop from Bearon, Emperorguin, Iceking, and Ice Lich','USEABLE'),
    ('Icy Fox Tail','use to temporarily increase cold damage by a small amount',14,5,'Target deals 1 point more cold damage till end of battle','30% drop from Fauxice, 50% drop from Freki, 70% dro from Bearon','USEABLE'),
    ('Icy Wolf Fang','When Equipped, raise physical and cold damage by a small amount',14,10,'Raise physical and cold damage by 1 when equipped','30% drop from Freki, 50% drop from Bearon','ACCESSORY'),
    ('Polar Bear Pelt','When Equipped, raise protection from cold, and weakness to heat',14,20,'Raise temp protection for cold','30% drop from Bearon','ACCESSORY'),
    ('Bronze Crown','When Equipped, look richer',14,10,'Raise rich trait by 1 while equipped','30% drop from Princeguin','ACCESSORY'),
    ('Silver Crown','When Equipped, look much more wealthy',14,20,'Raise Rich Trait by 2 while equipped','30% drop from kinguin','ACCESSORY'),
    ('Golden Crown','When Equipped, look fabulously wealthy',14,35,'Raise Rich Trait by 3 while equipped','30% drop from emperorguin','ACCESSORY'),
    ('Icy Stick','Spear with average stats that also does cold damage',14,2,'Deal 1 point physical and 1 point cold on hit','30% drop from Icebreaker, 50% drop from White Limper','WEAPON'),
    ('Icy Sword','Sword with above average stats that also does cold damage',14,10,'Deal 2 points of physical and 2 points of cold on hit','30% drop from White Limper','WEAPON'),
    ('Iceking Crown','Thorny crown that increases cold damage dealt',14,22,'While Equipped, deal 2 points of cold damage on hit','30% drop from iceking','ACCESSORY'),
    ('Ice Witch Cloak','Cold cloak that increases ice elemental damage dealt',14,14,'While equipped, increase ice skils by 2 points','30% drop from Ice Witch','ACCESSORY'),
    ('Ice Lich Soul','Equip to increase ice elemntal, magic, and cold damage dealt',14,35,'While equipped, increase ice, magic, and cold by 2 points','30% drop from Ice Lich','ACCESSORY'), 
    ('Transparent Meat','Use to heal health and deal damage to magic',15,3,'Target heals 1 point of health and takes 1 point of mana','30% drop from deepfish','USEABLE'),
    ('Ink','Use to weaken taret to water, and apply oil',15,6,'Target is vulnerable to water and oil','30% drop from Inker, 50% drop from Vasquid, 70% from Kraken','USEABLE'),
    ('Concealing Ink','Use to weaken target to water, apply oil, and increase evasion',15,12,'Target is vulnerable to water, oil and is 10% more evasive','30% drop from Vasquid, 50% drop from Kraken','USEABLE'),
    ('Kraken\'s Soul','Accessory that increases Water, darkness and physical damage',15,25,'While Equipped, increase water darkness and physical damage','30% drop from Kraken','ACCESSORY'),
    ('Throwing Starish','Use the corpse of this Starish as a throwing weapon, dealing a small amount of water, darkness, and physical damage on target',15,5,'Use to deal 1 point of water, darkness, and physical damage to a target','30% drop from Starish, 50% drop from ninjastar, 70% drop from Death Starfish','USEABLE'),
    ('Ninja Starish','Use the corpse of this ninja starish as a throwing weapon, dealing water, darkness and physcial damage to target',15,10,'Use to deal 2 points of water, darkness and physical damage to a target','30% drop from ninjastar, 50% drop from Death Starfish','USEABLE'),
    ('Death Starish','Use the corpse of this death starfish as a throwing weapon, dealing water, darkness and physical damage to target, with a small chance to instantly kill',15,20,'Use to deal 3 points of water, darkness and physical damage. 1% chance to kill non legend on target','30% drop from death starfish','USEABLE'),
    ('Jelly','Consume to slightly increase magic damage for the rest of the battle',15,4,'Use to increase magic damage by 1 for the rest of the battle','30% drop from Jelly, 50% drop from Prismatic Jelly, 70% drop from Jelly Woot','USEABLE'),
    ('Octomage Heart','While Equipped, slightly increase dark, water, and magic damage',15,12,'While Equipped, increase dark, water and magic damage by 1','30% drop from Octomage, 50% drop from Octocaster','ACCESSORY'),
    ('Octocaster Soul','While Equipped, increase dark, water and magic damage',15,24,'While equipped, increase dark, water and magic damage by 2','30% drop from Octocaster','ACCESSORY'),
    ('Prismatic Jelly','Consume to increase dark, water and magic damage for the rest of the battle',15,13,'When consumed, increase dark, water and magic damage by 3 until end of batle','30% drop from Prismatic Jelly, 50% drop from Jelly Woot','USEABLE'),
    ('Woot Jelly','Consume to greatly increase dark, water and magic damage for the rest of the battle',15,32,'When consumed, increase dark, water and magic damage by 4 until end of battle','30% drop from Jelly Woot','USEABLE'),
    ('Magic Leaf','Consume to heal very small wounds, works best on beings with an earth nature',20,1,'When consumed, heal 1 point of damage, and take 1 point of earth damage if no primary earth nature','30% drop from Sprite, 50% Poorprechaun, Aos Si, Shaboy, 70% Poshprechaun, Tallf, and Shaman, 90% Metafilthy Poshprechaun, Elder elf, and Shamage,','USEABLE'),
    ('Faded Four Leaf clover','consume to slightly increase item drop chance for the rest of the battle',20,2,'When consumed, increase item drop chance by 5%','30% drop from Poorprechaun, 50% drop from Poshprechaun, 70% drop from Metafilthy Poshprechaun','USEABLE'),
    ('Four Leag Clover','consume to increase item drop chance for the rest of the battle',20,7,'When consumed, increase item drop chance by 10%','30% drop from Poshprechaun, 50% drop from Metafilthy Poshprechaun','USEABLE'),
    ('Fool\'s Gold Clover','A four leaf clover made from fools gold, when equipped, increases item drop rates',20,13,'When Equipped, increase item drop chance by 5%','30% drop from Metafilthy Poshprechaun','ACCESSORY'),
    ('Shabby clothes','Faded, shabby clothes, that barely defend at all and make you look poor',20,1,'When Equipped, add 1 point of physical defense, and lower rich trait by 1,','30% drop from Poorprechaun','ARMOR'),
    ('Fine Clothes','Nice clothes that slightly defend the user',20,5,'When equipped, add 1 point of physical defense','30% drop from Poshprechaun','ARMOR'),
    ('Fancy Clothes','Uber fancy golden clothes that barely defends the user but makes them seem rich',20,5,'When Equipped, add 1 point of physical defense, and add 1 level of Rich Trait','30% drop from Metafilthy Poshprechaun','ARMOR'),
    ('Small Elf Ear','A small elf ear from a rabid elf, increases earth damage by 1 point while equipped',20,4,'When Equippped, increase Earth damage by 1 point','30% drop from Aos Si, 50% drop from Tallf, 70% drop from Elder Elf','ACCESSORY'),
    ('Elf Ear','An Elf ear of a rabid elf, increase earth damage and physical damage by 1 point while equipped',20,8,'When equipped, increase Earth and physcial damage by 1 point','30% drop from Aos si, 50% drop from Elder Elf','ACCESSORY'),
    ('Long Elf Ear','A majestic elf ear, slightly increases earth, physical and magical damage by 1 point while equipped',20,12,'When equipped, increase Earth, physical and magic damage by 1 point','30% drop from Elder Elf','ACCESSORY'),
    ('Minor Staff','A weak stick that somehow enhances magic',20,1,'When equipped, increase magic damage by 1 point,','30% drop from Shaboy, 50% drop from Shaman, 70% drop from Shamage','WEAPON'),
    ('Shaman Staff','A magic staff',20,5,'When equipped, increase magic damage by 2 points','30% drop from Shaman, 50% drop from shamage','WEAPON'),
    ('Shamage Staff','A powerful sage\'s staff',20,9,'When equipped, increase magic damage by 3 points','30% drop from Shamage','WEAPON'),
    ('Stick','Just a worthless stick. Can deal really feeble damage when weilded as a sword',21,0,'When equipped deal 1 point of physcial damage','30% drop from sticket, 50% drop form Throner, spriggan and Trig, 70% drop from Treant, Sylvan and Professtrig, 90% drop from arch Treant, Earth Mother, and Tenured Professtrig','WEAPON'),
    ('Thorn','On use, gain physical reflection damage',21,1,'On use, target gains 1 point of physical reflection damage','30% drop from Thorner, 50% drop from Treant, 70% drop from Arch Treant','USEABLE'),
    ('Shephard\'s crook','A staff of a forest shephard, which deals slight physical damage when equipped',21,1,'While equipped, deal 2 points of physical damage','30% drop from Treant, 50% drop from Arch Treant','WEAPON'),
    ('Treant Soul','Soul of a treat, increasing earth water and physical damage when equipped',21,20,'While equipped, deal a bonus point of 1 physical earth and water damage','30% drop from Arch Treant','ACCESSORY'),
    -- Spriggan drops vine rope
    ('Cloak of Leaves','Blessed by nature, this cloak will protect you from earth and magic damage when equipped',21,20,'While equipped, gain 2 points of earth and magic defense.','30% drop from Earth Mother','ARMOR'),
    ('Wand','This thinking stick increases magic damage when equipped as a weapon',21,2,'While equipped, deal additional 1 point of magic damage and 1 point of earth damage on magic attacks','30% drop from Trig, 50% drop from Professtrig, 70% drop from tenured professtrig','WEAPON'),
    ('Rowan Wand','This thinking stick increases magic and earth damage when equipped as a weapon',21,8,'While equipped, deal 2 additional points of magic and earth on magic attacks','30% drop from Professtrig, 50% drop from Tenured Professtrig','WEAPON'),
    ('Staff of Arcane Insight','This magic staff greatly increase magic and earth damage when equipped as a weapon',21,14,'While Equipped, deal 3 additional points of magic damage and earth on magic attacks, and 2 points of water damage on magic attacks','30% drop from Tenured Professtrig','WEAPON'),
    ('Bark','Wood from a plant monster that can be used to heal an immolated monster',22,0,'If single target is of type immolated, heal 1d4 health,','Base 30% Drop upon defeating a Bulbapup, base 60 drop upon defeating a Greenwolf, Base 90% drop on defeating a Sief, base 10% from Treant, professtrig, base 20% from Arch Treant and tenured Professtrig','USEABLE'),
    ...
    ('Vine Rope','Green Rope from a vine monster, can be use to fuel a fire or heal an immolated monster.',22,0,'If single target is immolated, heal 1d6 health.','Base 30% Drop upon defeating a Vine Wolf. 30% from defeating a spriggan','USEABLE'),
    ...
    ('Shiny Badge','Even shinier metal badge that increases physical armor when equipped',22,4,'Increase Physical defense by 2 while equipped','Base 30% drop from Honey Badger, 50% drop from honey badge bear','ACCESSORY'),
    ('Police Chief\'s Badge','This prominent metal badge projects authority, and increases defense when equipppe',22,12,'Increase Physcial defense by 3 while equipped','30% drop from honey Badge bear','ACCESSORY'),
    ('Tough Root','This tough root increases earth defense on target when used',22,2,'Increase Earth defense by 2 on use','30% drop from Green Wolf, 50% drop from Sief','USEABLE'),
    ('Greatsword','This massive weapon can only be weilded by the strongest of men',22,2,'Deal heavy physical damage on hit while equippped','30% drop from Sief','WEAPON'),
    ('Mystic Vine','Magic green vine that boosts earth damage on magic attacks',22,2,'Increase Earth Damage by 1 for rest of battle, does not stack','Base 30% drop from Aware Wolf, Base 50% drop from Mystic Wolf','USEABLE'),
    ('Enchanted Vine','Magic green vine that greatly increases earth damage on magic attacks',22,4,'Increase Earth damage on magic attacks by 2 for the rest of the battle','30% drop from Mystic Wolf','USEABLE'),
    ('Green Coin','Magic green coin that can be used to heal mp for monsters with a earth primary nature',22,10,'Heal 10mp if target\'s primary nature is earth','30% drop from terra symbol, 40% drop from Terra elemental, 25% drop from Luxor, Terra and Pyro Elementals, 60% drop from primordial terra elemental, 20% drop from all primordial elementals','USEABLE'),
    ('Jade','A lesser green stone used in jewelry making, can be consumed to improve relationships with Gaia and Earth monsters',22,20,'Gain affinity with Gaia and Terra Monsters','Base 50% drop from Jade, 70% drop from emerald','USEABLE'),
    ('Emerald','A shiny green gem used in jewelry making, can be consumed to greatly improve relationships with Gaia and Earth Monsters',22,50,'Gain Affinity with Gaia and Terra Monsters','Base 60% drop from Emerald','USEABLE'),
    ('Lock of Pegasus Hair','glowing hair that can be used to increase air and earth magic attacks for the rest of the battle',23,3,'Increase Air and earth magic attacks by 1 point','30% from Pegasus Foal, 50% from Lesser Pegasus, 70% from Pegasus, 90% from greater Pegasus','USEABLE'),
    ('Horseshoe','metal shoe that can be thrown at enemies',23,4,'Deal 1 point of phyiscal damage to enemy','30% drop from Lesser pegasus, 50% drop from Pegasus, 70% drop from Greater Pegasus','USEABLE'),
    ('Pegasus Feather','Magic feather that can be used to deal air and earth damage on target',23,8,'Deal 1 point of earth and air damage to enemy','30% drop from Pegasus, 50% drop from Greater Pegasus','USEABLE'),
    ('Pegasus Pinion','Magic feather that can be used to deal significant air and earth damage on target',23,12,'Deal 2 points of air and earth damage to enemy','30% drop from Greater Pegasus','USEABLE'),
    ('Featherleaf','A plants leaf, shaped like a feather, can be used to deal air and earth elemental damage to target',23,3,'Deal 2 points of air and earth damage to enemy','30% drop from Sapwing 50% drop from Wing Tree, 10 instances of 50% drop from flying forest','USEABLE'),
    -- Wing Tree drops Green Angel Feathers
    ('Monk Robe','Slightly increases healing while equipped',24,2,'Increase healing by 1 point','30% drop from Suddi, 50% drop from Sodisat and Theresat, 70& drop from Sodisatva and Theresatva, 90% drop from Haew Kwon and Bone Hae','ARMOR'),
    ('Prayer Beads','Accessory that increases healing while equipped',24,4,'Increase Healing by 1 point while equipped','30% drop from Sodisat and Theresat, 50% drop from Sodisatva and Theresatva, 70% drop from Hae Kwon and Bone Hae','ACCESSORY'),
    ('Clam Soul','Increases Clam damage done while equipped',24,2,'Increase Calm damage by 1 when equipped','30% drop from Sodisatva and Theresatva, 50% drop from Hae Kwong and Bone Hae','ACCESSORY'),
    ('Monk Master Robe','Increases Healing and Calm while equipped',24,5,'Increase Healing and Calm by 3 points while equipped','30% drop from Hae Kwong and Bone Hae','ARMOR'),
    ('Rat tail','Inflict Disease on target',25,1,'Deal 1 point of disease on target','30% drop from sewerat, 50% drop from Smaught and BoiledRat, 70% drop from Flint and Trenchrat, 90% drop from BeePee and PlagueRat','USEABLE'),
    ('Rotten Spike','Foul dagger that deals disease on hit',25,4,'While equipped deal 1 point of damage, and 1 point of disease damage','30% drop from Smaugh, 50% drop from Flint, 70% drop from BeePee','WEAPON'),
    ('Rot Shield','Foul shield that reflects some damage, and converts some incoming physical damage into disease damage',25,6,'While equippped, reflect 1 point of physical damage, convert 1 point of physical damage into disease damage','30% drop from Flint, 50% drop form BeePee','ACCESSORY'),
    ('Rotten Soul','Foul soul that increases physical damage and disease damage, but weakens physical and disease resistance',25,18,'While equipped increase physical and disease damage by 1 and decrease physical and disease defense by 1','30% drop from BeePee','ACCESSORY'),
    ('Boil','Foul pussy boil that can inflict poison and disease on target',25,1,'Deal 1 point of poison and 1 point of disease on target','30% drop from Boiledrat, 50% drop from Trenchrat, 70% drop from plaguerat','USEABLE'),
    ('Trenchrat Tooth','Can be used on target to add weakness to poison and darkness',25,6,'Deal 1 point of Poison and Darkness shield damage','30% drop from Trenchrat, 50% drop from Plaguerat','USEABLE'),
    ('Plague totem','Magical wand that can be used to cast dark rotten magics',25,12,'While equipped, increase poison, darkness, earth and disease magic by 1','30% drop from Plaguerat','WEAPON'),
    ('Foul Smoke','Use to inflict disease on everyone in the battle',25,5,'On use, deal 1 point of disease damage to entire battlefield','30% drop from Easedis, 50% drop from Lebris, 70% drop from Cancerbloat','USEABLE'),
    ('Disease Grenade','Use to inflict disease and poison to every member of the battle',25,10,'On use deal 1 point of disease and poison to every battlefield participant','30% drop from Lepris, 50% drop from Cancerbloat','USEABLE'),
    ('Plague Bomb','Use to inflict poison, disease, earth, darkness and magic damage to every battle participant',25,15,'On use deal 2 points of poison, disease, earht, darkness and magic damage to everyone on the battlefield','30% drop from Cancerbload','USEABLE'),
    ('Phoenix Tuft','Use to resurrect a character up to level 5',30,10,'Revive a character up to level 5. Add affinity to Bennu, remove from Thanatos.','30% drop from Minor Phoenix, 50% drop from Chol, and Firebird, 70% drop from Fawke and Fire Eagle, 90% drop from Fenghuang and Franzer','USEABLE'),
    ('Phoenix Down','Use to resurrect a character up to level 15',30,20,'Revive a character up to level 15. Add affinity to Bennu, remove from Thanatos.','30% drop from Chol and Firebird,  50% from Fawke and Fire Eagle, 70% drop from Fenghuang and Franzer','USEABLE'),
    ('Phoenix Feather','Use to resurrect a character up to level 25',30,30,'Revive a character up to level 35. Add affinity to Bennu, remove from Thanatos.','30% drop from Fawke and Fire Eagle, 50% Fenghuang and Franzer','USEABLE'),
    ('Phoenix Wing','Use to ressurect any character',30,50,'Revive a character. Add affinity to Bennu, remove from Thanatos.','30% drop from Fenghuang and Franzer','USEABLE'),
    -- Gullfish drops fish sale
    ('Bluebird Tuft','Use to deal wet and air damage to a target',31,2,'Deal 1 point of wet and air damage to a target','30% drop from Guller, 50% drop from Peligul, 70% drop from Heligul','USEABLE'),
    ('Bluebird feather','Use to deal wet water and air damage to a target',31,4,'Deal 2 points of wet, water and air to a target','30% drop from Peligul, 50% drop from Heligul','USEABLE'),
    ('Bluebird Wing','Use to deal wet water air and physical damage to a target',31, 6,'Deal 2 points of wet water and air to a target,','30% drop from Heligul','USEABLE'),
    ('Finwing','This fish is shaped like a wing? Use to deal air, water and magic damage to a target',31,3,'Deal 1 point of water and magic damage to a target','30% drop from Skipfish, 50% drop from Flyfish, 70% drop from Soarfish','USEABLE'),
    ('Fishscale armor','This armor is made of fishscales, and protects from water and physical damage',31,12,'Add 1 point of physical and 1 point of magic defense','30% drop from Flyfish, 50% drop from Soarfish','USEABLE'),
    ('Magic Finwing','Use to deal air water and magic damage to a target',31,14,'Deal 2 points of air water and magic to a target,','30% drop from Soarfish','USEABLE'),
    ('Colorful feather','On use, randomly increase defense of either air, earth, or water by a small amount',32, 1,'On target, add 1 point of air earth or water (determined randomly),','30% drop from colour, 50% drop from Tusamcan, Abstruse, 70% drop from Threesamcan, Fabstruse, 90% drop from foursamcan, Seusstruse','USEABLE'),
    ('Multicolored Beak','On use, randomly deal air, earth or water damage and physcial damage',32,5,'On target deal 1 point of air earth or water damage, and one point of physical damage','30% drop from Tusamcan, 50% Threesamcan, 70% from Foursamcan','USEABLE'),
    ('Large Multicolored Beak','On use, deal air earth water and physical damage',32,10,'On target deal 1 point of air earth, physical and water damage','30% drop for Threesamcan, 50% drop from Foursamcan','USEABLE'),
    ('Giant Multicolored Beak','On use, deal a significat amount of earth water and physical damage',32,15,'On target, deal 2 point of air water earth and physical damage','30% drop from foursamcan','USEABLE'),
    ('Peacock Tuft','On use, deal 1 point of water, earth or air damage',32,2,'On target, deal 1 point of air water or earth damage (randomly)','30% drop from Abstruse, 50% drop from Fabstruse, 70% drop from Seusstruse','USEABLE'),
    ('Peacock headdress','While equipped, gain small bonus to earth, air and water damage',32,12,'While equipped, gain 1 point of damage to earth, air and water','30% drop from Fabstruse, 50% drop from Seusstruse','ACCESSORY'),
    ...
    ('Cocka Crest','A great white feather, taken from the crest of a cocka, when used, slightly clears all status effects, both positive and negative',45,1,'Clear 1 point of all status effects, both positive and negative.','30% drop from Cockaone, 50% drop from Cockarude, Cockatwo and Smilebird, 70% drop from Cockadude, cockathree and lovebird, 90% drop from cockacrude, cockafour and motherbird','USEABLE'),
    ('Dirty Feather','A rough dirty feather, used to anger any who touch it',45,1,'Add 1 point of anger on use','30% drop from Cockarude, 50% drop from Cockadude, 70% drop from cockacrude','USEABLE'),
    ('Muscle Feather','A large tough feather, used to increase physical damage',45,5,'Add 1 point of physical damage buff on use','30% drop from cockadude, 50% drop form Cockacrude','USEABLE'),
    ('Sharp Feather','A sharp feather, which damages its target, and angers and increases the damage that target does',45,10,'Deal 3 points of damage, 3 points of anger, and increase damage by 3','30% drop from cockacrude','USEABLE'),
    ('White Cocka Crest','A great white feather from the crest of an adult cocka, when used, reduces all status effects',45,1,'Reduce all status effects by 2','30% drop from Cockatwo, 50% drop from Cockathree, 70% drop from cockafour','USEABLE'),
    ('Yellow Cocka Crest','A great yellow feather from the crest of a cocka leader, when used, significantly reduces all status effects on the target',45,10,'Reduce all status effects by 3','30% drop from cockathree, 50% drop from Cockafour','USEABLE'),
    ('Orange Cocka Crest','A great orange feather fromt he crest of a cocka matriarch, when used, greatly reduces all status effects on the target',45,20,'Reduce all status effects by 4','30% drop from cockafour','USEABLE'),
    ('Pink Cocka feather','A smilinge cocka feather, can be used to give a target a random positive status effect',45,5,'1 point of a random positive status effect on target','30% drop form smilebird, 50% drop from Lovebird, 70% drop from motherbird','USEABLE'),
    ('Maroon Cocka feather','A smiling maroon cocka feather, can be used to give a target a significant random status effect',45,10,'2 points of random poistive status effect on target','30% drop from lovebird, 50% drop from motherbird','USEABLE'),
    ('Motherbird wing','A magic wing that gives many random blessings',45,25,'3 instances of 2 random points of a positive status effect on target','30% drop from motherbird','USEABLE'),
    ...
    ('Obsidian','A lesser black stone, can be consumed to improve relationships with dark monsters and Gods',55,20,'Gain affinity with Enemy and Umbral Monsters','50% drop from Obsidian, 70% drop from Onyx, 30% drop from Vulcanous','USEABLE'),
    ('Onyx','A mesmerizing black gem, can be consumed to greatly improve relatonships with dark monsters and Gods',55,50,'Gain affinity with Enemy and Umbral Monsters','60% drop from Onyx, 5% drop from Vulcanous','USEABLE');
...
INSERT INTO deity_affinity_title(deity_id,deity_relationship_level_id,deity_affinity_title)
VALUES
	(0,1,'Heretic'),
    (0,2,'Betrayer'),
    (0,3,'Faithless'),
