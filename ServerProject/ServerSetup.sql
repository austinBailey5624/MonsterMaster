...
VALUES
    ...
    ('Stiket',21,131,132,133,NULL,'The Sticket pretends to be magical but isn\'t. Its very depressing huh? Its basically just a small stick that can move on its own. But its very good at listening, probably because it can\'t talk. If it could though it would always advise revenge by saying \'Sticket to em!\''),
