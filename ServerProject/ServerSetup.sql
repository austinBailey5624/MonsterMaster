...
VALUES
    ...
    ('Fish Scale','Slightly Increase target protection from water until end of battle',11,2,'Increase Water protection by 1 until end of battle','30% drop from Minnow, 50% drop from EdgeFin and Cuddlerfish, 70% drop from SliceFin and Snugglerfish, 90% dro from Blue Dragon and Leviathan','USEABLE'),
